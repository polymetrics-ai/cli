...
Implemented readable streams: `describe_trails`, `get_event_configuration`, `list_channels`, `list_dashboards`, `list_event_data_stores`, `list_imports`, `list_public_keys`, `list_trails`.

Blocked/planned parameterized read operations: `GetChannel`, `GetDashboard`, `GetEventDataStore`, `GetEventSelectors`, `GetImport`, `GetInsightSelectors`, `GetResourcePolicy`, `GetTrail`, `GetTrailStatus`, `ListImportFailures`, `ListTags`.
