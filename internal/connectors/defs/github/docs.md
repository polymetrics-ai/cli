...
249 covered rows map to existing streams, fixture-backed write actions, direct reads, or fixed GraphQL documents;
the remaining 1,355 rows are blocked/planned ledger entries, not implemented-count claims. Destructive,
...
- API coverage includes 249 covered connector rows and 1,355 blocked/planned ledger rows. The
