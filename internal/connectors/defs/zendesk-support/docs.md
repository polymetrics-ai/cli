...
- Fixture-only evidence remains unvalidated (`validated=0`). This bundle does not run live Zendesk credentials, live provider calls, live writes, VPS/Thaalam work, or release validation.
