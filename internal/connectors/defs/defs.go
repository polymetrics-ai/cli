...
//go:embed operation_endpoint_ledger.json */metadata.json */changefeed.json */polling_watermark.json */spec.json */streams.json */writes.json */schemas/* */docs.md */operations.json */cli_surface.json */certification.json */rate_limits.json */database.json
var FS embed.FS
