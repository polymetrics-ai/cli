...
The complete official ledger has 1,146 operations: 399 ETL/read, 637 reverse-ETL write/mutation, 6 direct/provider query/search/metadata, 87 binary/file read/transfer, 15 CDC/changefeed/audit/webhook, and 2 excluded/not-applicable callback endpoints.
...
- Generated lane counts: etl_read=399, reverse_etl_write=637, direct_read_query_search=6, binary_file=87, cdc_changefeed=15, excluded_not_applicable=2.
