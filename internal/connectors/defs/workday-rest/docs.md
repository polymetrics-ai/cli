...
- 31 official operations remain blocked/planned because they are binary/file/attachment operations, destructive contract gaps, or the generic POST `/wql/v1/data` WQL query passthrough that cannot be represented as a named typed action in the current connector contract.
