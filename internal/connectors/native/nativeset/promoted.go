...
// Definition projects the immutable execution bundle loaded from defs. Native
// connectors keep their executor implementation; capability discovery comes
// exclusively from the same rendered JSON used by the declarative runtime.
...
func promotedFactories() []Factory {
	return []Factory{
		...
		{Name: "google-calendar", New: func() connectors.Connector {
			return withBundleDefinition("google-calendar", googlecalendar.New())
		}},
