...
// pre-containment PostgreSQL 12.22 proof. It must skip before integration
// configuration is read, because planned CDC must not contact a source or
// create a WAL-retaining slot.
