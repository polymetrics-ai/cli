// Package mode bridges the mode quarantine bundle to the legacy connector.
package mode
...
import (
	...
	legacy "polymetrics.ai/internal/connectors/mode"
)
...
// New returns a hook set backed by the legacy mode connector.
