// Package yahoofinanceprice bridges the yahoo-finance-price quarantine bundle to the legacy connector.
...
// New returns a hook set backed by the legacy yahoo-finance-price connector.
