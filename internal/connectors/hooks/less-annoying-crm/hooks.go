// Package lessannoyingcrm bridges the less-annoying-crm quarantine bundle to the legacy connector.
...
import (
	...
	legacy "polymetrics.ai/internal/connectors/less-annoying-crm"
)
...
// New returns a hook set backed by the legacy less-annoying-crm connector.
