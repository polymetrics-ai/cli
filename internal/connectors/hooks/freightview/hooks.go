// Package freightview bridges the freightview quarantine bundle to the legacy connector.
package freightview
...
import (
	...
	legacy "polymetrics.ai/internal/connectors/freightview"
)
...
// New returns a hook set backed by the legacy freightview connector.
