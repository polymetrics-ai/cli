// Package metabase bridges the metabase quarantine bundle to the native connector.
package metabase
...
func init() {
	engine.RegisterHooks("metabase", func() engine.Hooks { return New() })
}
...
// New returns a hook set backed by the native metabase connector.
func New() engine.Hooks { return Hooks{Connector: native.New()} }

func (h Hooks) ConnectorName() string { return "metabase" }
