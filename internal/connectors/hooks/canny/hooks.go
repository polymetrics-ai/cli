// Package canny bridges the canny quarantine bundle to the legacy connector.
package canny
...
import (
	...
	legacy "polymetrics.ai/internal/connectors/canny"
...
// New returns a hook set backed by the legacy canny connector.
