// Package lokalise bridges the lokalise quarantine bundle to the legacy connector.
package lokalise
...
import (
	...
	legacy "polymetrics.ai/internal/connectors/lokalise"
)
...
// New returns a hook set backed by the legacy lokalise connector.
