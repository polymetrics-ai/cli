// Package mendeley bridges the mendeley quarantine bundle to the native connector.
package mendeley
...
import (
	...
	native "polymetrics.ai/internal/connectors/native/mendeley"
)
...
// New returns a hook set backed by the native mendeley connector.
