// Package basecamp bridges the basecamp quarantine bundle to the legacy connector.
package basecamp
...
import (
	...
	legacy "polymetrics.ai/internal/connectors/basecamp"
...
// New returns a hook set backed by the legacy basecamp connector.
