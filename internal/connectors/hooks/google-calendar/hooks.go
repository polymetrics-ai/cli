// Package googlecalendar bridges the google-calendar quarantine bundle to the native connector.
...
// New returns a hook set backed by the native google-calendar connector.
