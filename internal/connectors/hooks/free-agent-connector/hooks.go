// Package freeagentconnector bridges the free-agent-connector quarantine bundle to the native connector.
...
// New returns a hook set backed by the native free-agent-connector connector.
