// Package awscloudtrail bridges the aws-cloudtrail quarantine bundle to the legacy connector.
...
// New returns a hook set backed by the legacy aws-cloudtrail connector.
