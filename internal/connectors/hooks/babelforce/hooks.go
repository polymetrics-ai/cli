// Package babelforce bridges the babelforce quarantine bundle to the legacy connector.
package babelforce
...
import (
	...
	legacy "polymetrics.ai/internal/connectors/babelforce"
...
// New returns a hook set backed by the legacy babelforce connector.
