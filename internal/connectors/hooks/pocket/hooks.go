// Package pocket bridges the pocket quarantine bundle to the native connector.
package pocket
...
import (
	...
	native "polymetrics.ai/internal/connectors/native/pocket"
)
...
// New returns a hook set backed by the native pocket connector.
