// Package alphavantage bridges the alpha-vantage quarantine bundle to the legacy connector.
...
import (
	...
	legacy "polymetrics.ai/internal/connectors/alpha-vantage"
...
// New returns a hook set backed by the legacy alpha-vantage connector.
