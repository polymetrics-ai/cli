// Package googleanalyticsdataapi bridges the google-analytics-data-api quarantine bundle to the native connector.
...
// New returns a hook set backed by the native google-analytics-data-api connector.
