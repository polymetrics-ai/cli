// Package zohocampaign implements a read-only native Zoho Campaigns API connector.
package zohocampaign
...
const (
	connectorName  = "zoho-campaign"
	defaultBaseURL = "https://campaigns.zoho.com/api/v1.1"
...
func (Connector) Metadata() connectors.Metadata {
	return connectors.Metadata{Name: connectorName, DisplayName: "Zoho Campaign", IntegrationType: "api", Description: "Reads Zoho Campaigns lists, campaigns, and contacts through the Zoho Campaigns REST API.", Capabilities: connectors.Capabilities{Check: true, Catalog: true, Read: true, Write: false}}
}
...
var streamOrder = []string{"lists", "campaigns", "contacts"}

var streams = map[string]streamEndpoint{
	"lists":     {path: "lists", recordsPath: "lists", desc: "Zoho Campaigns mailing lists.", idKeys: []string{"listkey", "list_key", "id"}, nameKeys: []string{"listname", "list_name", "name"}, cursorKeys: []string{"modified_time", "updated_at"}},
	"campaigns": {path: "campaigns", recordsPath: "campaigns", desc: "Zoho Campaigns campaigns.", idKeys: []string{"campaign_key", "campaignkey", "id"}, nameKeys: []string{"campaign_name", "campaignname", "name"}, cursorKeys: []string{"modified_time", "updated_at"}},
	"contacts":  {path: "contacts", recordsPath: "contacts", desc: "Zoho Campaigns contacts.", idKeys: []string{"contact_id", "contact_key", "id"}, nameKeys: []string{"email", "first_name", "name"}, cursorKeys: []string{"modified_time", "updated_at"}},
}
...
func (c Connector) requester(cfg connectors.RuntimeConfig) (*connsdk.Requester, error) {
	...
	if token == "" {
		return nil, errors.New("zoho-campaign connector requires secret access_token")
	}
