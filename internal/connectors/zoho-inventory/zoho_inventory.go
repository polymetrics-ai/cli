// Package zohoinventory implements a read-only native Zoho Inventory API connector.
...
func (Connector) Metadata() connectors.Metadata {
	return connectors.Metadata{Name: connectorName, DisplayName: "Zoho Inventory", IntegrationType: "api", Description: "Reads Zoho Inventory contacts, items, and sales orders through the Zoho Inventory REST API.", Capabilities: connectors.Capabilities{Check: true, Catalog: true, Read: true, Write: false}}
}
...
var streamOrder = []string{"contacts", "items", "salesorders"}

var streams = map[string]streamEndpoint{
	"contacts":    {path: "contacts", recordsPath: "contacts", desc: "Zoho Inventory contacts.", idKeys: []string{"contact_id", "id"}, nameKeys: []string{"contact_name", "name"}, cursorKeys: []string{"last_modified_time", "updated_at"}},
	"items":       {path: "items", recordsPath: "items", desc: "Zoho Inventory items.", idKeys: []string{"item_id", "id"}, nameKeys: []string{"name", "item_name"}, cursorKeys: []string{"last_modified_time", "updated_at"}},
	"salesorders": {path: "salesorders", recordsPath: "salesorders", desc: "Zoho Inventory sales orders.", idKeys: []string{"salesorder_id", "id"}, nameKeys: []string{"salesorder_number", "number"}, cursorKeys: []string{"last_modified_time", "updated_at"}},
}
...
func (c Connector) requester(cfg connectors.RuntimeConfig) (*connsdk.Requester, error) {
	...
	if token == "" {
		return nil, errors.New("zoho-inventory connector requires secret access_token")
	}
