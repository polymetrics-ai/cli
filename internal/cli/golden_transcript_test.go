...
var goldenTranscriptInputs = []struct {
	...
	{Name: "bare_etl_transport_declarative_typed_destination_manual", Args: []string{"etl", "transport", "declarative-typed-destination"}},
	...
	{Name: "etl_transport_declarative_typed_destination_leaf_help_manual", Args: []string{"etl", "transport", "declarative-typed-destination", "--help"}},
