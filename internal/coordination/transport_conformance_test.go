...
// TestSharedTransportCoordinationConformance keeps the shared authenticated
// admission and rate-parking contracts executable using local deterministic
// fakes. It is not provider or database certification.
func TestSharedTransportCoordinationConformance(t *testing.T) {
