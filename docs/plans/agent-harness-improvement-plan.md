...
- `parent-issue-orchestration-loop.md` step 3 load-list omits
  `automated-review-routing-loop.md` and `coderabbit-review-loop.md` (covered only indirectly
...
4. Tighten cross-references (3.7): add `automated-review-routing-loop.md` and
   `coderabbit-review-loop.md` to `parent-issue-orchestration-loop.md` step 3; add
