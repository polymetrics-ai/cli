...
EMAIL (IMAP + SMTP)
  ...
  validation at internal/app/app.go:350-376 and a mode-aware change to
  persisted-cursor forwarding at internal/app/app.go:555-563. Sparse UID scan continuation needs
