...
```text
NAME
  pm connectors inspect source-solarwinds-service-desk - Solarwinds Service Desk connector manual

SYNOPSIS
  pm connectors inspect source-solarwinds-service-desk
  pm connectors inspect source-solarwinds-service-desk --json
  pm credentials add <name> --connector source-solarwinds-service-desk [--config key=value] [--from-env field=ENV] [--value-stdin field]
