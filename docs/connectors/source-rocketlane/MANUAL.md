# pm connectors inspect source-rocketlane

```text
NAME
  pm connectors inspect source-rocketlane - Rocketlane connector manual

SYNOPSIS
  pm connectors inspect source-rocketlane
  pm connectors inspect source-rocketlane --json
