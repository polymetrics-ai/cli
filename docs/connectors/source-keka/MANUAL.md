# pm connectors inspect source-keka

```text
NAME
  pm connectors inspect source-keka - Keka connector manual

SYNOPSIS
  pm connectors inspect source-keka
  pm connectors inspect source-keka --json
...
CONFIGURATION
  ...
  client_secret (string) required secret: Your client secret for secure authentication.
