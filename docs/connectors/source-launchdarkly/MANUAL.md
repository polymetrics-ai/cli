# pm connectors inspect source-launchdarkly

```text
NAME
  pm connectors inspect source-launchdarkly - LaunchDarkly connector manual

SYNOPSIS
  pm connectors inspect source-launchdarkly
  pm connectors inspect source-launchdarkly --json
