# pm connectors inspect source-survicate

```text
NAME
  pm connectors inspect source-survicate - Survicate connector manual

SYNOPSIS
  pm connectors inspect source-survicate
  pm connectors inspect source-survicate --json
  pm credentials add <name> --connector source-survicate [--config key=value] [--from-env field=ENV] [--value-stdin field]
