---
name: pm-destination-local-json
description: Local JSON connector knowledge and safe action guide.
---

# pm-destination-local-json
...
```bash
pm connectors inspect destination-local-json
```

### Inspect as JSON

```bash
pm connectors inspect destination-local-json --json
```
