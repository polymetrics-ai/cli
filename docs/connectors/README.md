...
- [zoom](zoom/MANUAL.md): Reads Zoom users, meetings, webinars, and bounded module-specific data through the Zoom REST API; includes approval-gated clinical-note status updates.
