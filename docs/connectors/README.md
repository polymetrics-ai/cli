...
- [aws-cloudtrail](aws-cloudtrail/MANUAL.md): Reads AWS CloudTrail configuration and event metadata, runs bounded CloudTrail query/lookups, and executes typed approval-gated CloudTrail administration actions through fixed AWS JSON-RPC operations.
