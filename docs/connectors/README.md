...
- [linear](linear/MANUAL.md): Reads Linear GraphQL list/connection data and exposes only fixed GraphQL reverse-ETL mutations whose payloads do not require success:Boolean! assertions.
