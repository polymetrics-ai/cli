...
- [jira](jira/MANUAL.md): Reads Jira Cloud issues, projects, and users; exposes bounded JSON direct reads; and declares approval-gated reverse ETL actions from the official Jira Cloud REST API v3 ledger (269 executable write actions, 616 operations accounted).
