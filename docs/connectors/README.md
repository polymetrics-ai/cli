...
- [zoom](zoom/MANUAL.md): Reads Zoom users, meetings, and webinars, and plans two source-backed approval-gated Zoom warehouse destination actions through the Zoom REST API.
