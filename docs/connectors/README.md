...
- [postgres](postgres/MANUAL.md): Reads PostgreSQL tables: discovers schemas/columns from information_schema, snapshots tables with bounded cursor-incremental reads, and supports fixture-safe bounded row DML/truncate reverse ETL actions. CDC is a documented stub pending the gated pglogrepl dependency.
