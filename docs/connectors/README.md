...
- [notion](notion/MANUAL.md): Reads and writes Notion users, pages, blocks, data sources, databases, comments, views, meeting notes, search results, and file-upload metadata through the official Notion API.
