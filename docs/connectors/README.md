...
- [gitlab](gitlab/MANUAL.md): Runs 582 source-bound direct reads, four GitLab REST ETL streams, and 147 approval-gated reverse-ETL actions; its 1,752-row provider ledger retains a cited named-foundation outcome for every remaining source operation.
