...
- [dockerhub](dockerhub/MANUAL.md): Reads public Docker Hub repositories and image tags for a configured username or organization, and, with an optional Personal Access Token, manages access tokens, organizations, groups/teams, invites, audit logs, and repositories via the Docker Hub API.
