...
- [crisp](crisp/MANUAL.md): Crisp REST API v1 connector with explicit executable coverage for the official 220-operation surface: bounded JSON direct reads for GET endpoints and gated reverse-ETL actions for mutations.
