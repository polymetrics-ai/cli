...
- [crisp](crisp/MANUAL.md): Inventory scaffold for the Crisp REST API v1 connector. The official 220-operation surface is recorded in api_surface.json and cli_surface.json; executable streams, direct reads, binary policy, and reverse-ETL writes land in follow-up #204 subissues before this parent is ready.
