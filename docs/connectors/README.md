...
- [recurly](recurly/MANUAL.md): Reads Recurly accounts, subscriptions, invoices, transactions, catalog, usage, exports, and preview resources through the Recurly v3 API, and models typed reverse-ETL write actions for official endpoints.
