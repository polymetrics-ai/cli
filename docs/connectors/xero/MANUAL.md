...
COMMAND SURFACE
  ...
  Other Commands
    ...
    create bank transaction history record apply - Plan and execute the create bank transaction history record reverse-ETL action. [intent=reverse_etl availability=implemented write=create_bank_transaction_history_record]; approval: requires plan, preview, approval, and execute; risk: creates Xero bank transaction history record resources in the connected tenant; approval required; flags: --HistoryRecords (required), --bank_transaction_id (required)
    ...
    delete bank transfers apply - Plan and execute the delete bank transfers reverse-ETL action. [intent=reverse_etl availability=implemented write=delete_bank_transfers]; approval: requires plan, preview, approval, and execute; risk: Destructive Xero Accounting API action: sets one or more bank transfers to DELETED; reverse ETL must preview records and require explicit approval before execute.; flags: --BankTransfers (required)
    ...
    create bank transfer history record apply - Plan and execute the create bank transfer history record reverse-ETL action. [intent=reverse_etl availability=implemented write=create_bank_transfer_history_record]; approval: requires plan, preview, approval, and execute; risk: creates Xero bank transfer history record resources in the connected tenant; approval required; flags: --HistoryRecords (required), --bank_transfer_id (required)
    delete batch payment apply - Show the exact delete batch payment action and its declaration-bound typed-input hold. [intent=reverse_etl availability=partial write=delete_batch_payment]; approval: Partial command: ambiguous BatchPaymentID: string,null. A declaration-bound scalar-union input capability is required before this exact action can collect every documented value shape; no raw request body is accepted.; risk: deletes Xero batch payment resources in the connected tenant; approval required
    ...
    delete batch payment by url param apply - Show the exact delete batch payment by url param action and its declaration-bound typed-input hold. [intent=reverse_etl availability=partial write=delete_batch_payment_by_url_param]; approval: Partial command: ambiguous Status: string,null. A declaration-bound scalar-union input capability is required before this exact action can collect every documented value shape; no raw request body is accepted.; risk: deletes Xero batch payment by url param resources in the connected tenant; approval required
    create batch payment history record apply - Plan and execute the create batch payment history record reverse-ETL action. [intent=reverse_etl availability=implemented write=create_batch_payment_history_record]; approval: requires plan, preview, approval, and execute; risk: creates Xero batch payment history record resources in the connected tenant; approval required; flags: --HistoryRecords (required), --batch_payment_id (required)
    ...
    create contact history apply - Plan and execute the create contact history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_contact_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero contact history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --contact_id (required)
    ...
    create credit note history apply - Plan and execute the create credit note history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_credit_note_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero credit note history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --credit_note_id (required)
    ...
    create expense claim history apply - Plan and execute the create expense claim history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_expense_claim_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero expense claim history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --expense_claim_id (required)
    ...
    create invoice history apply - Plan and execute the create invoice history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_invoice_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero invoice history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --invoice_id (required)
    ...
    create item history apply - Plan and execute the create item history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_item_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero item history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --item_id (required)
    ...
    create manual journal history record apply - Plan and execute the create manual journal history record reverse-ETL action. [intent=reverse_etl availability=implemented write=create_manual_journal_history_record]; approval: requires plan, preview, approval, and execute; risk: creates Xero manual journal history record resources in the connected tenant; approval required; flags: --HistoryRecords (required), --manual_journal_id (required)
    ...
    create overpayment history apply - Plan and execute the create overpayment history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_overpayment_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero overpayment history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --overpayment_id (required)
    ...
    delete payment apply - Show the exact delete payment action and its declaration-bound typed-input hold. [intent=reverse_etl availability=partial write=delete_payment]; approval: Partial command: ambiguous Status: string,null. A declaration-bound scalar-union input capability is required before this exact action can collect every documented value shape; no raw request body is accepted.; risk: deletes Xero payment resources in the connected tenant; approval required
    create payment history apply - Plan and execute the create payment history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_payment_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero payment history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --payment_id (required)
    ...
    create prepayment history apply - Plan and execute the create prepayment history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_prepayment_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero prepayment history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --prepayment_id (required)
    ...
    create purchase order history apply - Plan and execute the create purchase order history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_purchase_order_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero purchase order history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --purchase_order_id (required)
    ...
    create quote history apply - Plan and execute the create quote history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_quote_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero quote history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --quote_id (required)
    ...
    create receipt history apply - Plan and execute the create receipt history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_receipt_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero receipt history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --receipt_id (required)
    ...
    create repeating invoice history apply - Plan and execute the create repeating invoice history reverse-ETL action. [intent=reverse_etl availability=implemented write=create_repeating_invoice_history]; approval: requires plan, preview, approval, and execute; risk: creates Xero repeating invoice history resources in the connected tenant; approval required; flags: --HistoryRecords (required), --repeating_invoice_id (required)
