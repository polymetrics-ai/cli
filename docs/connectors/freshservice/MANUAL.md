...
```text
NAME
  pm connectors inspect freshservice - Freshservice connector manual

SYNOPSIS
  pm connectors inspect freshservice
  pm connectors inspect freshservice --json
  pm credentials add <name> --connector freshservice [--config key=value] [--from-env field=ENV] [--value-stdin field]
