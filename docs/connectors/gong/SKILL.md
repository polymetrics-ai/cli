...
- Calls
  ...
  - calls users-access get - Retrieve users that have specific individual access to calls (/v2/calls/users-access) [intent=direct_read availability=implemented operation=gong.calls_users_access_get]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --call-id (required)
  - calls transcript - Retrieve transcripts of calls (/v2/calls/transcript) [intent=direct_read availability=implemented operation=gong.calls_transcript]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --call-id (required), --from, --to, --workspace-id, --cursor
...
- Users
  ...
  - users extensive - List users by filter (/v2/users/extensive) [intent=direct_read availability=implemented operation=gong.users_extensive]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --user-id, --created-from, --created-to, --include-avatars, --cursor
- Scorecards
...
- Stats
  - stats interaction - Retrieve interaction stats for applicable users by date (/v2/stats/interaction) [intent=direct_read availability=implemented operation=gong.stats_interaction]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --from-date (required), --to-date (required), --user-id, --created-from, --created-to, --cursor
  - stats activity-scorecards - Retrieve answered scorecards for applicable reviewed users or scorecards for a date range (/v2/stats/activity/scorecards) [intent=direct_read availability=implemented operation=gong.stats_activity_scorecards]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --call-from-date, --call-to-date, --review-from-date, --review-to-date, --review-method, --reviewed-user-id, --scorecard-id (required), --cursor
...
- Engage Flows
  ...
  - flows steps - Get flow details and steps for one or more Engage flows (/v2/flows/steps) [intent=direct_read availability=implemented operation=gong.flows_steps]; approval: none: read-only POST query with schema-gated body; risk: bounded POST read-query; sends only typed flow ID array body fields and redacts sensitive response fields; notes: Executes through the typed operation direct-read engine; no raw body flag is exposed.; flags: --flow-id (required)
  - flows prospects - List prospects assigned flows (/v2/flows/prospects) [intent=direct_read availability=implemented operation=gong.flows_prospects]; approval: none: read-only POST query with schema-gated body; risk: bounded POST read-query; sends only typed CRM prospect or flow instance ID arrays and redacts sensitive response fields; notes: Executes through the typed operation direct-read engine; no raw body flag is exposed.; flags: --crm-prospect-id, --flow-instance-id
- Library
...
- Tasks
  ...
  - tasks list - List user's tasks (/v2/tasks) [intent=direct_read availability=implemented operation=gong.tasks_list]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --user-id (required), --status (required), --task-action (required), --task-type (required), --workspace-id
