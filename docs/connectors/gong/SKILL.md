...
- Calls
  ...
  - calls extensive - Retrieve detailed call data by various filters (/v2/calls/extensive) [intent=direct_read availability=implemented operation=gong.calls_extensive]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --call-id (required), --from, --to, --primary-user-id, --workspace-id, --cursor, --context, --context-timing, --include-parties, --include-media, --include-public-comments, --include-brief, --include-call-outcome, --include-highlights, --include-key-points, --include-outline, --include-structure, --include-topics, --include-trackers, --include-tracker-occurrences, --include-speakers, --include-questions, --include-person-stats, --include-video-stats, --page, --page-cursor
  ...
  - calls transcript - Retrieve transcripts of calls (/v2/calls/transcript) [intent=direct_read availability=implemented operation=gong.calls_transcript]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --call-id (required), --from, --to, --workspace-id, --cursor, --page, --page-cursor
...
- Users
  ...
  - users extensive - List users by filter (/v2/users/extensive) [intent=direct_read availability=implemented operation=gong.users_extensive]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --user-id, --created-from, --created-to, --include-avatars, --cursor, --page, --page-cursor
- Scorecards
...
- Stats
  - stats interaction - Retrieve interaction stats for applicable users by date (/v2/stats/interaction) [intent=direct_read availability=implemented operation=gong.stats_interaction]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --from-date (required), --to-date (required), --user-id, --created-from, --created-to, --cursor, --page, --page-cursor
  - stats activity-scorecards - Retrieve answered scorecards for applicable reviewed users or scorecards for a date range (/v2/stats/activity/scorecards) [intent=direct_read availability=implemented operation=gong.stats_activity_scorecards]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --call-from-date, --call-to-date, --review-from-date, --review-to-date, --review-method, --reviewed-user-id, --scorecard-id (required), --cursor, --page, --page-cursor
...
- Logs
  - logs list - Retrieve logs data by type and time range (/v2/logs) [intent=direct_read availability=implemented]; risk: bounded Gong JSON read; response is limited to 1 MiB and secret/download/content-shaped fields are redacted; flags: --logType, --fromDateTime, --toDateTime, --cursor, --page, --page-cursor
- Coaching
