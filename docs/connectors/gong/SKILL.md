...
- Calls
  ...
  - calls extensive - Retrieve detailed call data by various filters (/v2/calls/extensive) [intent=direct_read availability=implemented operation=gong.calls_extensive]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --call-id, --from, --to, --primary-user-id, --workspace-id, --cursor, --context, --context-timing, --include-parties, --include-media, --include-public-comments, --include-brief, --include-call-outcome, --include-highlights, --include-key-points, --include-outline, --include-structure, --include-topics, --include-trackers, --include-tracker-occurrences, --include-speakers, --include-questions, --include-person-stats, --include-video-stats
  - calls users-access get - Retrieve users that have specific individual access to calls (/v2/calls/users-access) [intent=direct_read availability=implemented operation=gong.calls_users_access_get]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --call-id
  - calls transcript - Retrieve transcripts of calls (/v2/calls/transcript) [intent=direct_read availability=implemented operation=gong.calls_transcript]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --call-id, --from, --to, --workspace-id, --cursor
...
- Meetings
  ...
  - meetings integration-status - Validate Gong meeting Integration (/v2/meetings/integration/status) [intent=direct_read availability=implemented operation=gong.meetings_integration_status]; approval: none: read-only POST query with schema-gated body; risk: bounded POST read-query; sends only typed email array body fields and redacts sensitive response fields; notes: Executes through the typed operation direct-read engine; no raw body flag is exposed.; flags: --email
- Engagement
...
- Stats
  ...
  - stats activity-scorecards - Retrieve answered scorecards for applicable reviewed users or scorecards for a date range (/v2/stats/activity/scorecards) [intent=direct_read availability=implemented operation=gong.stats_activity_scorecards]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --call-from-date, --call-to-date, --review-from-date, --review-to-date, --review-method, --reviewed-user-id, --scorecard-id, --cursor
...
- Engage Flows
  ...
  - flows steps - Get flow details and steps for one or more Engage flows (/v2/flows/steps) [intent=direct_read availability=implemented operation=gong.flows_steps]; approval: none: read-only POST query with schema-gated body; risk: bounded POST read-query; sends only typed flow ID array body fields and redacts sensitive response fields; notes: Executes through the typed operation direct-read engine; no raw body flag is exposed.; flags: --flow-id
...
- Tasks
  ...
  - tasks list - List user's tasks (/v2/tasks) [intent=direct_read availability=implemented operation=gong.tasks_list]; approval: none: read-only POST query with schema-gated body; risk: bounded typed POST read-query; response size is capped and secret/download/content-shaped fields are redacted; notes: Executes through the typed operation direct-read engine; no raw body or generic HTTP flag is exposed.; flags: --user-id, --status, --task-action, --task-type, --workspace-id
