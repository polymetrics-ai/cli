# pm connectors inspect source-drip

```text
NAME
  pm connectors inspect source-drip - Drip connector manual

SYNOPSIS
  pm connectors inspect source-drip
  pm connectors inspect source-drip --json
  pm credentials add <name> --connector source-drip [--config key=value] [--from-env field=ENV] [--value-stdin field]
