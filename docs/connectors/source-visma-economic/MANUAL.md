...
```text
NAME
  pm connectors inspect source-visma-economic - Visma Economic connector manual

SYNOPSIS
  pm connectors inspect source-visma-economic
  pm connectors inspect source-visma-economic --json
  pm credentials add <name> --connector source-visma-economic [--config key=value] [--from-env field=ENV] [--value-stdin field]
