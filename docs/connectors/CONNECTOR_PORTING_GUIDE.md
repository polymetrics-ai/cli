# Connector Registry To pm Native Porting Guide
...
Replicate upstream connector behavior in Go without running connector registry connector images or Python/Java/Kotlin/Ruby code at product runtime.
...
- connector registry low-code manifest reference: manual intervention needed
- connector registry protocol: manual intervention needed
- Connector metadata: manual intervention needed
- Stripe source manifest: https://github.com/connector-registryhq/registry artifact
- GitHub source implementation: https://github.com/connector-registryhq/registry artifact
- Postgres source implementation: https://github.com/connector-registryhq/registry artifact
- Postgres destination implementation: https://github.com/connector-registryhq/registry artifact
- S3 source implementation: https://github.com/connector-registryhq/registry artifact
