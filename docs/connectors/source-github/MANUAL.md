...
```text
NAME
  pm connectors inspect source-github - GitHub connector manual

SYNOPSIS
  pm connectors inspect source-github
  pm connectors inspect source-github --json
...
AGENT WORKFLOW
  - This catalog slug delegates to the enabled pm connector github.
  - Run pm connectors inspect source-github before creating credentials or plans.
