# pm connectors inspect source-shipstation

```text
NAME
  pm connectors inspect source-shipstation - Shipstation connector manual

SYNOPSIS
  pm connectors inspect source-shipstation
  pm connectors inspect source-shipstation --json
