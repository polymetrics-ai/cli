...
Declarative Google Ads connector for v22 customer, campaign, ad group, direct-read, and guarded reverse-ETL API surfaces.
...
- write risk: guarded Google Ads API reverse/write actions generated from fixed v22 methods; destructive/admin actions require explicit approval
- approval: reads require no approval; writes remain gated by plan -> preview -> explicit approval -> execute
- Never pass secret values in chat, shell arguments, logs, docs, or JSON output.

## Command Surface

- Google Ads v22 fixed direct reads and guarded reverse/write actions.
...
- Other Commands
  ...
  - customers asset-generations generate-text - Read Google Ads customers.assetGenerations.generateText. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --advertising-channel-type, --asset-field-types, --final-url, --freeform-prompt, --keywords
  - customers generate-ad-group-themes - Read Google Ads customers.generateAdGroupThemes. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --ad-groups, --keywords
  - customers generate-audience-composition-insights - Read Google Ads customers.generateAudienceCompositionInsights. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --customer-insights-group, --data-month, --dimensions
  - customers generate-audience-overlap-insights - Read Google Ads customers.generateAudienceOverlapInsights. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --customer-insights-group, --dimensions
  - customers generate-creator-insights - Read Google Ads customers.generateCreatorInsights. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --customer-insights-group
  - customers generate-insights-finder-report - Read Google Ads customers.generateInsightsFinderReport. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --customer-insights-group
  - customers generate-keyword-forecast-metrics - Read Google Ads customers.generateKeywordForecastMetrics. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --currency-code
  ...
  - customers generate-reach-forecast - Read Google Ads customers.generateReachForecast. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --cookie-frequency-cap, --currency-code, --customer-reach-group, --min-effective-frequency
  - customers generate-shareable-previews - Read Google Ads customers.generateShareablePreviews. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.
  ...
  - customers generate-targeting-suggestion-metrics - Read Google Ads customers.generateTargetingSuggestionMetrics. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --customer-insights-group
  - customers generate-trending-insights - Read Google Ads customers.generateTrendingInsights. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --customer-insights-group
  ...
  - customers invoices list - Read Google Ads customers.invoices.list. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.
  ...
  - customers recommendations generate - Read Google Ads customers.recommendations.generate. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --advertising-channel-type, --campaign-call-asset-count, --campaign-image-asset-count, --campaign-sitelink-count, --conversion-tracking-status, --country-codes, --language-codes, --merchant-center-account-id, --negative-locations-ids, --positive-locations-ids, --recommendation-types, --target-content-network, --target-partner-search-network
  - customers search-audience-insights-attributes - Read Google Ads customers.searchAudienceInsightsAttributes. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --customer-insights-group, --dimensions, --query-text
  - customers suggest-brands - Read Google Ads customers.suggestBrands. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --brand-prefix, --selected-brands
  - customers suggest-keyword-themes - Read Google Ads customers.suggestKeywordThemes. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.
  - customers suggest-smart-campaign-ad - Read Google Ads customers.suggestSmartCampaignAd. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.
  - customers suggest-smart-campaign-budget-options - Read Google Ads customers.suggestSmartCampaignBudgetOptions. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --campaign
  - customers suggest-travel-assets - Read Google Ads customers.suggestTravelAssets. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --language-option, --place-ids
  ...
  - google-ads-fields search - Read Google Ads googleAdsFields.search. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --page-size, --page-token, --query
  ...
  - v22 generate-conversion-rates - Read Google Ads v22.generateConversionRates. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --customer-id, --customer-reach-group
  ...
  - v22 list-plannable-products - Read Google Ads v22.listPlannableProducts. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --plannable-location-id
  - v22 list-plannable-user-interests - Read Google Ads v22.listPlannableUserInterests. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --customer-id, --name-query, --path-query, --user-interest-taxonomy-types
  - v22 list-plannable-user-lists - Read Google Ads v22.listPlannableUserLists. [intent=direct_read availability=implemented]; approval: none; risk: Bounded JSON direct read; response fields with secret-like names are redacted.; flags: --customer-id, --customer-reach-group
