...
```text
NAME
  pm connectors inspect source-less-annoying-crm - Less Annoying CRM connector manual

SYNOPSIS
  pm connectors inspect source-less-annoying-crm
  pm connectors inspect source-less-annoying-crm --json
  pm credentials add <name> --connector source-less-annoying-crm [--config key=value] [--from-env field=ENV] [--value-stdin field]
