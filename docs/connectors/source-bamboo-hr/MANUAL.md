...
DESCRIPTION
  BambooHR catalog connector for https://docs.airbyte.com/integrations/sources/bamboo-hr. Native implementation status: planned_native_port.
...
IMPLEMENTATION STATUS
  ...
  upstream image reference: airbyte/source-bamboo-hr:0.9.3 (metadata only; not executed)
...
OFFICIAL APPLICATION DOCUMENTATION
  ...
  Airbyte connector documentation: https://docs.airbyte.com/integrations/sources/bamboo-hr
...
DOCUMENTATION
  https://docs.airbyte.com/integrations/sources/bamboo-hr
...
SEE ALSO
  BambooHR documentation: https://docs.airbyte.com/integrations/sources/bamboo-hr
