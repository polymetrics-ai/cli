...
COMMAND SURFACE
  ...
  Agents
    agents get-agents-for-workspace - Get a list of agents in a workspace. [intent=direct_read availability=implemented operation=get_agents_for_workspace]; flags: --workspace-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  AI Studio usage API
    ai-studio-usage-api get-ai-studio-runs - Get AI Studio credit utilization. [intent=direct_read availability=implemented operation=get_ai_studio_runs]; flags: --workspace-gid (required, max 4096 bytes), --division-gid (max 4096 bytes), --end-at (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --start-at (max 4096 bytes), --page, --page-cursor
    ai-studio-usage-api get-ai-studio-seats - Get AI Studio seats. [intent=direct_read availability=implemented operation=get_ai_studio_seats]; flags: --workspace-gid (required, max 4096 bytes), --division-gid (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --state (max 4096 bytes), --page, --page-cursor
  Allocations
    ...
    allocations get-allocations - Get multiple allocations. [intent=direct_read availability=implemented operation=get_allocations]; flags: --assignee (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --parent (max 4096 bytes), --workspace (max 4096 bytes), --page, --page-cursor
  ...
  Attachments
    ...
    attachments get-attachments-for-object - Get attachments from an object. [intent=direct_read availability=implemented operation=get_attachments_for_object]; flags: --parent (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Audit log API
    audit-log-api get-audit-log-events - Get audit log events. [intent=direct_read availability=implemented operation=get_audit_log_events]; notes: Blocked until CDC/changefeed foundations #2986/#2988 supply truthfulness and lifecycle evidence.; flags: --workspace-gid (required, max 4096 bytes), --actor-gid (max 4096 bytes), --actor-type (max 4096 bytes), --end-at (max 4096 bytes), --event-type (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --resource-gid (max 4096 bytes), --start-at (max 4096 bytes), --page, --page-cursor
  Batch API
  ...
  Custom field settings
    custom-field-settings get-custom-field-settings-for-project - Get a project's custom fields. [intent=direct_read availability=implemented operation=get_custom_field_settings_for_project]; flags: --project-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    custom-field-settings get-custom-field-settings-for-portfolio - Get a portfolio's custom fields. [intent=direct_read availability=implemented operation=get_custom_field_settings_for_portfolio]; flags: --portfolio-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    custom-field-settings get-custom-field-settings-for-goal - Get a goal's custom fields. [intent=direct_read availability=implemented operation=get_custom_field_settings_for_goal]; flags: --goal-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Custom types
    custom-types get-custom-types - Get all custom types associated with an object. [intent=direct_read availability=implemented operation=get_custom_types]; flags: --project (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Goal relationships
    ...
    goal-relationships get-goal-relationships - Get goal relationships. [intent=direct_read availability=implemented operation=get_goal_relationships]; flags: --supported-goal (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --resource-subtype (max 4096 bytes), --page, --page-cursor
  ...
  Goals
    ...
    goals get-goals - Get goals. [intent=direct_read availability=implemented operation=get_goals]; flags: --is-workspace-level (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --portfolio (max 4096 bytes), --project (max 4096 bytes), --task (max 4096 bytes), --team (max 4096 bytes), --workspace (max 4096 bytes), --page, --page-cursor
  ...
  Memberships
    memberships get-memberships - Get multiple memberships. [intent=direct_read availability=implemented operation=get_memberships]; flags: --limit (max 4096 bytes), --member (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --parent (max 4096 bytes), --resource-subtype (max 4096 bytes), --page, --page-cursor
    ...
    memberships get-membership - Planned fixed-target Asana read: Get a membership. [intent=etl availability=planned operation=get_membership]; notes: missing_foundation=source-bound-read-execution-r1: missing foundation cli-openapi30-reference-sibling-foundation-r1; source_operation=asana.rest.getMembership; flags: --membership-gid (non-empty, max 4096 bytes)
  ...
  Ooo entries
    ...
    ooo-entries get-ooo-entries - Get OOO entries for a user. [intent=direct_read availability=implemented operation=get_ooo_entries]; flags: --user (required, max 4096 bytes), --workspace (required, max 4096 bytes), --end-date (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --start-date (max 4096 bytes), --page, --page-cursor
  ...
  Portfolio memberships
    portfolio-memberships get-portfolio-memberships - Get multiple portfolio memberships. [intent=direct_read availability=implemented operation=get_portfolio_memberships]; flags: --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --portfolio (max 4096 bytes), --user (max 4096 bytes), --workspace (max 4096 bytes), --page, --page-cursor
    ...
    portfolio-memberships get-portfolio-memberships-for-portfolio - Get memberships from a portfolio. [intent=direct_read availability=implemented operation=get_portfolio_memberships_for_portfolio]; flags: --portfolio-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --user (max 4096 bytes), --page, --page-cursor
  Portfolios
    portfolios get-portfolios - Get multiple portfolios. [intent=direct_read availability=implemented operation=get_portfolios]; flags: --workspace (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --owner (max 4096 bytes), --page, --page-cursor
    ...
    portfolios get-items-for-portfolio - Get portfolio items. [intent=direct_read availability=implemented operation=get_items_for_portfolio]; flags: --portfolio-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Project memberships
    ...
    project-memberships get-project-memberships-for-project - Get memberships from a project. [intent=direct_read availability=implemented operation=get_project_memberships_for_project]; flags: --project-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --user (max 4096 bytes), --page, --page-cursor
  Project portfolio settings
    ...
    project-portfolio-settings get-project-portfolio-settings-for-project - Get project portfolio settings for a project. [intent=direct_read availability=implemented operation=get_project_portfolio_settings_for_project]; flags: --project-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    project-portfolio-settings get-project-portfolio-settings-for-portfolio - Get project portfolio settings for a portfolio. [intent=direct_read availability=implemented operation=get_project_portfolio_settings_for_portfolio]; flags: --portfolio-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  Project statuses
  ...
  Project templates
    ...
    project-templates get-project-templates - Get multiple project templates. [intent=direct_read availability=implemented operation=get_project_templates]; flags: --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --team (max 4096 bytes), --workspace (max 4096 bytes), --page, --page-cursor
    project-templates get-project-templates-for-team - Get a team's project templates. [intent=direct_read availability=implemented operation=get_project_templates_for_team]; flags: --team-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Projects
    ...
    projects get-projects-for-task - Get projects a task is in. [intent=direct_read availability=implemented operation=get_projects_for_task]; flags: --task-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    projects get-projects-for-team - Get a team's projects. [intent=direct_read availability=implemented operation=get_projects_for_team]; flags: --team-gid (required, max 4096 bytes), --archived (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    ...
    projects get-projects-for-workspace - Get all projects in a workspace. [intent=direct_read availability=implemented operation=get_projects_for_workspace]; flags: --workspace-gid (required, max 4096 bytes), --archived (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Rates
    rates get-rates - Get multiple rates. [intent=direct_read availability=implemented operation=get_rates]; flags: --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --parent (max 4096 bytes), --resource (max 4096 bytes), --page, --page-cursor
  ...
  Reactions
    reactions get-reactions-on-object - Get reactions with an emoji base on an object. [intent=direct_read availability=implemented operation=get_reactions_on_object]; flags: --emoji-base (required, max 4096 bytes), --target (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  Roles
    roles get-roles - Get multiple roles. [intent=direct_read availability=implemented operation=get_roles]; flags: --archived (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --workspace (max 4096 bytes), --page, --page-cursor
  ...
  Status updates
    ...
    status-updates get-statuses-for-object - Get status updates from an object. [intent=direct_read availability=implemented operation=get_statuses_for_object]; flags: --parent (required, max 4096 bytes), --created-since (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Stories
    ...
    stories get-stories-for-goal - Get stories from a goal. [intent=direct_read availability=implemented operation=get_stories_for_goal]; flags: --goal-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Tags
    ...
    tags get-tags-for-task - Get a task's tags. [intent=direct_read availability=implemented operation=get_tags_for_task]; flags: --task-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    tags get-tags-for-workspace - Get tags in a workspace. [intent=direct_read availability=implemented operation=get_tags_for_workspace]; flags: --workspace-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Task templates
    task-templates get-task-templates - Get multiple task templates. [intent=direct_read availability=implemented operation=get_task_templates]; flags: --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --project (max 4096 bytes), --page, --page-cursor
  ...
  Tasks
    ...
    tasks get-tasks-for-project - Get tasks from a project. [intent=direct_read availability=implemented operation=get_tasks_for_project]; flags: --project-gid (required, max 4096 bytes), --completed-since (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    tasks get-tasks-for-section - Get tasks from a section. [intent=direct_read availability=implemented operation=get_tasks_for_section]; flags: --section-gid (required, max 4096 bytes), --completed-since (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    tasks get-tasks-for-tag - Get tasks from a tag. [intent=direct_read availability=implemented operation=get_tasks_for_tag]; flags: --tag-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    tasks get-tasks-for-user-task-list - Get tasks from a user task list. [intent=direct_read availability=implemented operation=get_tasks_for_user_task_list]; flags: --user-task-list-gid (required, max 4096 bytes), --completed-since (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    tasks get-subtasks-for-task - Get subtasks from a task. [intent=direct_read availability=implemented operation=get_subtasks_for_task]; flags: --task-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    ...
    tasks get-dependencies-for-task - Get dependencies from a task. [intent=direct_read availability=implemented operation=get_dependencies_for_task]; flags: --task-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    ...
    tasks get-dependents-for-task - Get dependents from a task. [intent=direct_read availability=implemented operation=get_dependents_for_task]; flags: --task-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Team memberships
    ...
    team-memberships get-team-memberships-for-team - Get memberships from a team. [intent=direct_read availability=implemented operation=get_team_memberships_for_team]; flags: --team-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    team-memberships get-team-memberships-for-user - Get memberships from a user. [intent=direct_read availability=implemented operation=get_team_memberships_for_user]; flags: --user-gid (required, max 4096 bytes), --workspace (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  Teams
    ...
    teams get-teams-for-user - Get teams for a user. [intent=direct_read availability=implemented operation=get_teams_for_user]; flags: --user-gid (required, max 4096 bytes), --organization (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Time periods
    ...
    time-periods get-time-periods - Get time periods. [intent=direct_read availability=implemented operation=get_time_periods]; flags: --workspace (required, max 4096 bytes), --end-on (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --start-on (max 4096 bytes), --page, --page-cursor
  Time tracking categories
    ...
    time-tracking-categories get-time-tracking-entries-for-time-tracking-category - Get time tracking entries for a time tracking category. [intent=direct_read availability=implemented operation=get_time_tracking_entries_for_time_tracking_category]; flags: --time-tracking-category-gid (required, max 4096 bytes), --end-date (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --start-date (max 4096 bytes), --page, --page-cursor
    time-tracking-categories get-time-tracking-categories - Get time tracking categories for a workspace. [intent=direct_read availability=implemented operation=get_time_tracking_categories]; flags: --workspace (required, max 4096 bytes), --is-archived (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Time tracking entries
    time-tracking-entries get-time-tracking-entries-for-task - Get time tracking entries for a task. [intent=direct_read availability=implemented operation=get_time_tracking_entries_for_task]; flags: --task-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    ...
    time-tracking-entries get-time-tracking-entries - Get multiple time tracking entries. [intent=direct_read availability=implemented operation=get_time_tracking_entries]; flags: --attributable-to (max 4096 bytes), --entered-on-end-date (max 4096 bytes), --entered-on-start-date (max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --portfolio (max 4096 bytes), --task (max 4096 bytes), --timesheet-approval-status (max 4096 bytes), --user (max 4096 bytes), --workspace (max 4096 bytes), --page, --page-cursor
  ...
  Users
    ...
    users get-favorites-for-user - Get a user's favorites. [intent=direct_read availability=implemented operation=get_favorites_for_user]; flags: --user-gid (required, max 4096 bytes), --resource-type (required, max 4096 bytes), --workspace (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    users get-users-for-team - Get users in a team. [intent=direct_read availability=implemented operation=get_users_for_team]; flags: --team-gid (required, max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
    users get-users-for-workspace - Get users in a workspace or organization. [intent=direct_read availability=implemented operation=get_users_for_workspace]; flags: --workspace-gid (required, max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
  ...
  Webhooks
    webhooks get-webhooks - Get multiple webhooks. [intent=direct_read availability=implemented operation=get_webhooks]; notes: Blocked until CDC/changefeed foundations #2986/#2988 supply truthfulness and lifecycle evidence.; flags: --workspace (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --resource (max 4096 bytes), --page, --page-cursor
  ...
  Workspace memberships
    ...
    workspace-memberships get-workspace-memberships-for-user - Get workspace memberships for a user. [intent=direct_read availability=implemented operation=get_workspace_memberships_for_user]; flags: --user-gid (required, max 4096 bytes), --limit (max 4096 bytes), --offset (max 4096 bytes), --opt-pretty (max 4096 bytes), --page, --page-cursor
