...
COMMAND SURFACE
  ...
  Other Commands
    ...
    gists create - Create a gist [intent=reverse_etl availability=partial write=gists_create]; approval: reverse ETL writes require plan, approval, execute; preview is optional.; risk: Creates provider-side state: Create a gist.; notes: Required record field(s) files have no scalar leaf, so no flag can carry them from the command line; the write action is declared and reachable through reverse ETL with a record payload.; flags: --description, --public
    ...
    orgs update-pat-accesses - Update the access to organization resources via fine-grained personal access tokens [intent=reverse_etl availability=partial write=orgs_update_pat_accesses]; approval: reverse ETL writes require plan, approval, execute; preview is optional.; risk: Creates provider-side state: Update the access to organization resources via fine-grained personal access tokens.; notes: Required record field(s) pat_ids have no scalar leaf, so no flag can carry them from the command line; the write action is declared and reachable through reverse ETL with a record payload.; flags: --org (required), --action (required)
    ...
    pull-request-stacks create - Create a pull request stack [intent=reverse_etl availability=partial write=pull_request_stacks_create]; approval: reverse ETL writes require plan, approval, execute; preview is optional.; risk: Creates provider-side state: Create a pull request stack.; notes: Required record field(s) pull_requests have no scalar leaf, so no flag can carry them from the command line; the write action is declared and reachable through reverse ETL with a record payload.
    pull-request-stacks add - Add pull requests to a pull request stack [intent=reverse_etl availability=partial write=pull_request_stacks_add]; approval: reverse ETL writes require plan, approval, execute; preview is optional.; risk: Creates provider-side state: Add pull requests to a pull request stack.; notes: Required record field(s) pull_requests have no scalar leaf, so no flag can carry them from the command line; the write action is declared and reachable through reverse ETL with a record payload.; flags: --stack-number (required)
    ...
    graphql mutation create-migration-source - Prepare fixed GitHub GraphQL mutation createMigrationSource. [intent=direct_write availability=unsafe_or_disallowed operation=github.graphql.mutation.create-migration-source]; approval: blocked pending an env-only typed GraphQL secret input channel; risk: high; notes: Blocked: the source-derived input includes a sensitive field and pm has no env-only typed GraphQL variable channel.; flags: --input (required)
    ...
    graphql mutation delete-issue - Prepare fixed GitHub GraphQL mutation deleteIssue. [intent=direct_write availability=unsafe_or_disallowed operation=github.graphql.mutation.delete-issue]; approval: blocked by recorded GitHub provider/product decision; risk: critical; notes: Blocked by the recorded provider/product decision: GitHub issue deletion remains unavailable through pm.; flags: --input (required)
    ...
    graphql mutation regenerate-verifiable-domain-token - Prepare fixed GitHub GraphQL mutation regenerateVerifiableDomainToken. [intent=direct_write availability=unsafe_or_disallowed operation=github.graphql.mutation.regenerate-verifiable-domain-token]; approval: blocked pending an env-only typed GraphQL secret input channel; risk: high; notes: Blocked: the source-derived input includes a sensitive field and pm has no env-only typed GraphQL variable channel.; flags: --input (required)
    ...
    graphql mutation start-organization-migration - Prepare fixed GitHub GraphQL mutation startOrganizationMigration. [intent=direct_write availability=unsafe_or_disallowed operation=github.graphql.mutation.start-organization-migration]; approval: blocked pending an env-only typed GraphQL secret input channel; risk: high; notes: Blocked: the source-derived input includes a sensitive field and pm has no env-only typed GraphQL variable channel.; flags: --input (required)
    graphql mutation start-repository-migration - Prepare fixed GitHub GraphQL mutation startRepositoryMigration. [intent=direct_write availability=unsafe_or_disallowed operation=github.graphql.mutation.start-repository-migration]; approval: blocked pending an env-only typed GraphQL secret input channel; risk: high; notes: Blocked: the source-derived input includes a sensitive field and pm has no env-only typed GraphQL variable channel.; flags: --input (required)
    ...
    graphql mutation transfer-issue - Prepare fixed GitHub GraphQL mutation transferIssue. [intent=direct_write availability=implemented operation=github.graphql.mutation.transfer-issue]; approval: plan, preview, approval, execute; risk: high; flags: --input (required)
