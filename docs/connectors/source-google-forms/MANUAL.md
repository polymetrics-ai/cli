# pm connectors inspect source-google-forms

```text
NAME
  pm connectors inspect source-google-forms - Google Forms connector manual

SYNOPSIS
  pm connectors inspect source-google-forms
  pm connectors inspect source-google-forms --json
  pm credentials add <name> --connector source-google-forms [--config key=value] [--from-env field=ENV] [--value-stdin field]
