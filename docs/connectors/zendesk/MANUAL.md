...
COMMAND SURFACE
  ...
  Read Commands
    ...
    binary show-attachment - Show Attachment [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --attachment-id
    binary list-bookmarks - List Bookmarks [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary list-custom-object-record-attachments - List Custom Object Record Attachments [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --custom-object-key, --record-id
    binary download-custom-object-record-attachment - Download Custom Object Record Attachment [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --custom-object-key, --record-id, --id
    binary list-deleted-tickets - List Deleted Tickets [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary list-dynamic-contents - List Items [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary show-dynamic-content-item - Show Item [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --dynamic-content-item-id
    binary dynamic-content-list-variants - List Variants [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --dynamic-content-item-id
    binary show-dynamic-content-variant - Show Variant [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --dynamic-content-item-id, --dynamic-content-variant-id
    binary show-many-dynamic-contents - Show Many Items [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary incremental-sample-export - Incremental Sample Export [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --incremental-resource
    binary incremental-custom-object-record-export-cursor - Incremental Custom Object Record Export, Cursor Based [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --custom-object-key
    binary incremental-organization-export - Incremental Organization Export [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary incremental-skil-based-routing-attribute-values-export - Incremental Attributes Values Export [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary incremental-skil-based-routing-attributes-export - Incremental Attributes Export [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary incremental-skil-based-routing-instance-values-export - Incremental Instance Values Export [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary incremental-ticket-events - Incremental Ticket Event Export [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary list-ticket-metric-events - List Ticket Metric Events [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary incremental-ticket-export-time - Incremental Ticket Export, Time Based [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary incremental-ticket-export-cursor - Incremental Ticket Export, Cursor Based [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary incremental-user-export-time - Incremental User Export, Time Based [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary incremental-user-export-cursor - Incremental User Export, Cursor Based [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary list-macro-attachments - List Macro Attachments [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --macro-id
    binary show-macro-attachment - Show Macro Attachment [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --attachment-id
    binary list-search-results - List Search Results [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary export-search-results - Export Search Results [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary list-skips - List All Skips [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary list-ticket-audits - List All Ticket Audits [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary list-ticket-content-pins - List Ticket Content Pins [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary list-ticket-metrics - List Ticket Metrics [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.
    binary list-audits-for-ticket - List Audits for a Ticket [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --ticket-id
    binary list-ticket-comments - List Comments [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --ticket-id
    binary list-ticket-skips-by-ticket - List Ticket Skips By Ticket [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --ticket-id
    binary show-ticket-by-messaging-conversation-id - Show Ticket by Messaging Conversation ID [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --conversation-id
    binary list-ticket-skips - List Ticket Skips [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --user-id
    binary execute-view - Execute View [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --view-id
    binary export-view - Export View [intent=direct_read availability=implemented]; risk: Metadata-only binary/file read; response body bytes are never emitted or written to disk.; notes: Executes a bounded GET and returns a binary manifest with content type, content length, bytes read, truncation status, and body_redacted=true.; flags: --view-id
  Write Candidates
