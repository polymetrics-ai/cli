...
COMMAND SURFACE
  ...
  Read/list commands
    ...
    attachments list - Planned bounded Linear Query.attachments command. [intent=direct_read availability=planned]; notes: Planned only: fixed GraphQL direct operation execution is not enabled for Linear in this connector-local slice.
