# pm connectors inspect source-kissmetrics

```text
NAME
  pm connectors inspect source-kissmetrics - Kissmetrics connector manual

SYNOPSIS
  pm connectors inspect source-kissmetrics
  pm connectors inspect source-kissmetrics --json
  pm credentials add <name> --connector source-kissmetrics [--config key=value] [--from-env field=ENV] [--value-stdin field]
