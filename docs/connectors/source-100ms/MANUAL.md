# pm connectors inspect source-100ms

```text
NAME
  pm connectors inspect source-100ms - 100ms connector manual

SYNOPSIS
  pm connectors inspect source-100ms
  pm connectors inspect source-100ms --json
...
CONFIGURATION
  ...
  secret fields: management_token
