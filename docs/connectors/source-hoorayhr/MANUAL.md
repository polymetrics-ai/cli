# pm connectors inspect source-hoorayhr

```text
NAME
  pm connectors inspect source-hoorayhr - HoorayHR connector manual

SYNOPSIS
  pm connectors inspect source-hoorayhr
  pm connectors inspect source-hoorayhr --json
...
CONFIGURATION
  ...
  secret fields: hoorayhrpassword
