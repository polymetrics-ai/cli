# pm connectors inspect source-aha

```text
NAME
  pm connectors inspect source-aha - Aha connector manual

SYNOPSIS
  pm connectors inspect source-aha
  pm connectors inspect source-aha --json
  pm credentials add <name> --connector source-aha [--config key=value] [--from-env field=ENV] [--value-stdin field]
