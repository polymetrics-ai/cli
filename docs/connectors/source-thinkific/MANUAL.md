# pm connectors inspect source-thinkific

```text
NAME
  pm connectors inspect source-thinkific - Thinkific connector manual

SYNOPSIS
  pm connectors inspect source-thinkific
  pm connectors inspect source-thinkific --json
  pm credentials add <name> --connector source-thinkific [--config key=value] [--from-env field=ENV] [--value-stdin field]
...
CONFIGURATION
  api_key (string) required secret: Your Thinkific API key for authentication.
  subdomain (string) required: The subdomain of your Thinkific URL (e.g., if your URL is example.thinkific.com, your subdomain is "example".
