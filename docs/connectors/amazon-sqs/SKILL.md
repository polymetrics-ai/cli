...
- Run Amazon SQS's declared streams and reverse-ETL actions.
- Usage: pm amazon-sqs <command> [flags]
- Read streams
- Reverse ETL writes
- Other Commands
  ...
  - message change-visibility - Plan a typed Amazon SQS change message visibility operation. [intent=reverse_etl availability=implemented write=change_message_visibility]; approval: requires plan, preview, approval, and execute; risk: changes the visibility timeout for one in-flight message; flags: --receipt_handle (required), --visibility_timeout (required)
  - message change-visibility-batch - Plan a typed Amazon SQS change message visibility batch operation. [intent=reverse_etl availability=implemented write=change_message_visibility_batch]; approval: requires plan, preview, approval, and execute; risk: changes visibility timeout for up to 10 in-flight messages per SQS batch request; flags: --receipt_handle (required), --visibility_timeout (required)
  - message delete - Plan a typed Amazon SQS delete message operation. [intent=reverse_etl availability=implemented write=delete_message]; approval: requires plan, preview, approval, and execute; risk: deletes one received message by receipt handle; flags: --receipt_handle (required)
  - message delete-batch - Plan a typed Amazon SQS delete message batch operation. [intent=reverse_etl availability=implemented write=delete_message_batch]; approval: requires plan, preview, approval, and execute; risk: deletes up to 10 received messages per SQS batch request; flags: --receipt_handle (required)
  - message send - Plan a typed Amazon SQS send message operation. [intent=reverse_etl availability=implemented write=send_message]; approval: requires plan, preview, approval, and execute; risk: sends one message to the configured queue; FIFO queues may use message_deduplication_id for provider-supported idempotency; flags: --message_body (required)
  - message send-batch - Plan a typed Amazon SQS send message batch operation. [intent=reverse_etl availability=implemented write=send_message_batch]; approval: requires plan, preview, approval, and execute; risk: sends up to 10 messages per SQS batch request; FIFO queues may use message_deduplication_id for provider-supported idempotency; flags: --message_body (required)
  - message-move-task cancel - Plan a typed Amazon SQS cancel message move task operation. [intent=reverse_etl availability=implemented write=cancel_message_move_task]; approval: requires plan, preview, approval, and execute; risk: cancels an in-flight dead-letter-queue message move task; flags: --task_handle (required)
  - message-move-task start - Plan a typed Amazon SQS start message move task operation. [intent=reverse_etl availability=implemented write=start_message_move_task]; approval: requires plan, preview, approval, and execute; risk: starts an SQS dead-letter queue redrive message move task; flags: --source_arn (required)
  ...
  - permission add - Plan a typed Amazon SQS add permission operation. [intent=reverse_etl availability=implemented write=add_permission]; approval: requires plan, preview, approval, and execute; risk: adds an SQS queue resource policy permission statement for listed AWS account ids; flags: --actions (required), --aws_account_ids (required), --label (required)
  - permission remove - Plan a typed Amazon SQS remove permission operation. [intent=reverse_etl availability=implemented write=remove_permission]; approval: requires plan, preview, approval, and execute; risk: removes an SQS queue resource policy permission statement; flags: --label (required)
  ...
  - queue create - Plan a typed Amazon SQS create queue operation. [intent=reverse_etl availability=implemented write=create_queue]; approval: requires plan, preview, approval, and execute; risk: creates an SQS queue; SQS returns an existing queue URL when name and attributes match; flags: --queue_name (required)
  - queue delete - Plan a typed Amazon SQS delete queue operation. [intent=reverse_etl availability=implemented write=delete_queue]; approval: requires plan, preview, approval, and execute; risk: deletes the configured SQS queue
  - queue purge - Plan a typed Amazon SQS purge queue operation. [intent=reverse_etl availability=implemented write=purge_queue]; approval: requires plan, preview, approval, and execute; risk: purges all available messages from the configured queue
  - queue set-attributes - Plan a typed Amazon SQS set queue attributes operation. [intent=reverse_etl availability=implemented write=set_queue_attributes]; approval: requires plan, preview, approval, and execute; risk: sets typed SQS queue attributes such as policy, redrive, encryption, retention, and visibility settings
  - queue tag - Plan a typed Amazon SQS tag queue operation. [intent=reverse_etl availability=implemented write=tag_queue]; approval: requires plan, preview, approval, and execute; risk: adds or updates tags on the configured SQS queue
  ...
  - queue untag - Plan a typed Amazon SQS untag queue operation. [intent=reverse_etl availability=implemented write=untag_queue]; approval: requires plan, preview, approval, and execute; risk: removes tags from the configured SQS queue; flags: --tag_keys (required)
