# pm connectors inspect source-mailerlite

```text
NAME
  pm connectors inspect source-mailerlite - MailerLite connector manual

SYNOPSIS
  pm connectors inspect source-mailerlite
  pm connectors inspect source-mailerlite --json
