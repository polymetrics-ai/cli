# pm connectors inspect source-harness

```text
NAME
  pm connectors inspect source-harness - Harness connector manual

SYNOPSIS
  pm connectors inspect source-harness
  pm connectors inspect source-harness --json
  pm credentials add <name> --connector source-harness [--config key=value] [--from-env field=ENV] [--value-stdin field]
