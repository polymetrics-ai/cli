# pm connectors inspect source-recreation

```text
NAME
  pm connectors inspect source-recreation - Recreation connector manual

SYNOPSIS
  pm connectors inspect source-recreation
  pm connectors inspect source-recreation --json
  pm credentials add <name> --connector source-recreation [--config key=value] [--from-env field=ENV] [--value-stdin field]
