...
BoldSign catalog connector for https://docs.airbyte.com/integrations/sources/boldsign. Native implementation status: planned_native_port.
...
- upstream image reference: airbyte/source-boldsign:0.0.31 (metadata only; not executed)
...
- Airbyte connector documentation: https://docs.airbyte.com/integrations/sources/boldsign
...
- https://docs.airbyte.com/integrations/sources/boldsign
...
- [BoldSign documentation](https://docs.airbyte.com/integrations/sources/boldsign)
