# pm connectors inspect source-revenuecat

```text
NAME
  pm connectors inspect source-revenuecat - RevenueCat connector manual

SYNOPSIS
  pm connectors inspect source-revenuecat
  pm connectors inspect source-revenuecat --json
