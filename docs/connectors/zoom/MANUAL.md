...
DESCRIPTION
  Reads Zoom users, meetings, webinars, bounded module-specific data, SCIM2 groups/users, Virtual Agent knowledge-base/report data, and Auto Dialer call history, reports, call lists, and prospects through the Zoom REST API; includes sensitive Cobrowse SDK, SCIM2, Virtual Agent, and Auto Dialer reads, approval-gated Chatbot, SCIM2, Virtual Agent, Auto Dialer, clinical-note, and Quality Management actions, and a redacted Customer Managed Keys Hybrid archival key action.
...
SECURITY
  read risk: external Zoom API read of user, meeting, webinar, Quality of Service, AI Companion, My Notes, healthcare clinical-note, Quality Management, Cobrowse SDK session, SCIM2 user/group, Virtual Agent knowledge-base/report, and Auto Dialer call-history/report/call-list/prospect data
  write risk: typed Zoom Chatbot message, Link Unfurls, SCIM2 group/user, Virtual Agent article/sync, Auto Dialer call-list/prospect, healthcare clinical-note, and Quality Management actions, plus Customer Managed Keys Hybrid archival key decryption with redacted output
  approval: mutating commands require plan, preview, explicit approval, and execute; Chatbot, SCIM2, Virtual Agent article, and Auto Dialer call-list/prospect deletion plus Customer Managed Keys Hybrid archival key decryption additionally require typed confirmation; read-only commands require none
  Never pass secret values in chat, shell arguments, logs, docs, or JSON output.

COMMAND SURFACE
  Run declared Zoom stream reads, bounded module-specific direct reads, approval-gated Chatbot, SCIM2, Virtual Agent, Auto Dialer, clinical-note, and Quality Management actions, and a redacted Customer Managed Keys Hybrid archival key action.
