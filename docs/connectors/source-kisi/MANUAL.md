# pm connectors inspect source-kisi

```text
NAME
  pm connectors inspect source-kisi - Kisi connector manual

SYNOPSIS
  pm connectors inspect source-kisi
  pm connectors inspect source-kisi --json
  pm credentials add <name> --connector source-kisi [--config key=value] [--from-env field=ENV] [--value-stdin field]
