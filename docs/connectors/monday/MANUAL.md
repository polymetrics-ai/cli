...
DESCRIPTION
  Reads monday.com GraphQL streams and plans fixed bounded query operations; models typed Monday GraphQL mutations for reverse ETL through named actions with approval gates.
...
REVERSE ETL ACTIONS
  ...
  create_doc_block:
    ...
    risk: high: runs Monday mutation create_doc_block; reverse ETL approval required
  create_folder:
    endpoint: POST
  ...
  update_doc_block:
    ...
    risk: high: runs Monday mutation update_doc_block; reverse ETL approval required
  update_doc_name:
    endpoint: POST
...
SECURITY
  read risk: external monday.com GraphQL API reads; ETL streams remain executable, while fixed query operations are planned until shared GraphQL errors[] and duplicate POST / classifier handling lands
...
COMMAND SURFACE
  ...
  Global flags:
    ...
    --max-bytes (integer): Maximum bytes to return when planned bounded query commands become executable.
  ETL streams
  ...
  Planned bounded GraphQL query commands
    query account - Planned fixed Monday account query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.account. Fixed GraphQL document for account remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query account-roles - Planned fixed Monday account_roles query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.account_roles. Fixed GraphQL document for account_roles remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query aggregate - Planned fixed Monday aggregate query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.aggregate. Blocked on connector-local schema for complex GraphQL variables; no raw GraphQL escape hatch. Also blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation.
    query all-widgets-schema - Planned fixed Monday all_widgets_schema query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.all_widgets_schema. Fixed GraphQL document for all_widgets_schema remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query allowed-sequences-to-enroll - Planned fixed Monday allowed_sequences_to_enroll query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.allowed_sequences_to_enroll. Fixed GraphQL document for allowed_sequences_to_enroll remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --board-id
    query app - Planned fixed Monday app query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.app. Fixed GraphQL document for app remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --id
    query app-installs - Planned fixed Monday app_installs query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.app_installs. Fixed GraphQL document for app_installs remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --app-id, --account-id
    query app-subscription - Planned fixed Monday app_subscription query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.app_subscription. Fixed GraphQL document for app_subscription remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query app-subscription-operations - Planned fixed Monday app_subscription_operations query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.app_subscription_operations. Fixed GraphQL document for app_subscription_operations remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --kind
    query app-subscriptions - Planned fixed Monday app_subscriptions query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.app_subscriptions. Fixed GraphQL document for app_subscriptions remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --app-id
    query apps-monetization-info - Planned fixed Monday apps_monetization_info query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.apps_monetization_info. Fixed GraphQL document for apps_monetization_info remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query apps-monetization-status - Planned fixed Monday apps_monetization_status query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.apps_monetization_status. Fixed GraphQL document for apps_monetization_status remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query article-blocks - Planned fixed Monday article_blocks query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.article_blocks. Fixed GraphQL document for article_blocks remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --object-id, --limit, --page
    query articles - Planned fixed Monday articles query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.articles. Blocked on connector-local schema for complex GraphQL variables; no raw GraphQL escape hatch. Also blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation.
    query ask-developer-docs - Planned fixed Monday ask_developer_docs query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.ask_developer_docs. Fixed GraphQL document for ask_developer_docs remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --query
    query audit-event-catalogue - Planned fixed Monday audit_event_catalogue query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.audit_event_catalogue. Fixed GraphQL document for audit_event_catalogue remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query audit-logs - Planned fixed Monday audit_logs query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.audit_logs. Blocked on connector-local schema for complex GraphQL variables; no raw GraphQL escape hatch. Also blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation.
    query complexity - Planned fixed Monday complexity query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.complexity. Fixed GraphQL document for complexity remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query connection-board-ids - Planned fixed Monday connection_board_ids query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.connection_board_ids. Fixed GraphQL document for connection_board_ids remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --connection-id
    query custom-activity - Planned fixed Monday custom_activity query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.custom_activity. Fixed GraphQL document for custom_activity remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query departments - Planned fixed Monday departments query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.departments. Blocked on connector-local schema for complex GraphQL variables; no raw GraphQL escape hatch. Also blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation.
    query doc-version-diff - Planned fixed Monday doc_version_diff query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.doc_version_diff. Fixed GraphQL document for doc_version_diff remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --doc-id, --date, --prev-date
    query doc-version-history - Planned fixed Monday doc_version_history query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.doc_version_history. Fixed GraphQL document for doc_version_history remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --doc-id, --since
    query docs - Planned fixed Monday docs query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.docs. Fixed GraphQL document for docs remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --ids
    query export-markdown-from-doc - Planned fixed Monday export_markdown_from_doc query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.export_markdown_from_doc. Blocked on connector-local schema for complex GraphQL variables; no raw GraphQL escape hatch. Also blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation.
    query favorites - Planned fixed Monday favorites query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.favorites. Fixed GraphQL document for favorites remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query fetch-job-status - Planned fixed Monday fetch_job_status query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.fetch_job_status. Fixed GraphQL document for fetch_job_status remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --job-id
    query folders - Planned fixed Monday folders query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.folders. Blocked on connector-local schema for complex GraphQL variables; no raw GraphQL escape hatch. Also blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation.
    query form - Planned fixed Monday form query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.form. Fixed GraphQL document for form remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --formtoken
    query get-app-lifecycle-subscriptions - Planned fixed Monday get_app_lifecycle_subscriptions query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.get_app_lifecycle_subscriptions. Fixed GraphQL document for get_app_lifecycle_subscriptions remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --app-id, --version-id
    query get-column-type-schema - Planned fixed Monday get_column_type_schema query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.get_column_type_schema. Fixed GraphQL document for get_column_type_schema remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query get-directory-resources - Planned fixed Monday get_directory_resources query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.get_directory_resources. Fixed GraphQL document for get_directory_resources remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --limit
    query get-object-schemas - Planned fixed Monday get_object_schemas query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.get_object_schemas. Fixed GraphQL document for get_object_schemas remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --limit, --page
    query get-view-schema-by-type - Planned fixed Monday get_view_schema_by_type query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.get_view_schema_by_type. Fixed GraphQL document for get_view_schema_by_type remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query items-page-by-column-values - Planned fixed Monday items_page_by_column_values query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.items_page_by_column_values. Blocked on connector-local schema for complex GraphQL variables; no raw GraphQL escape hatch. Also blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation.
    query job-status - Planned fixed Monday job_status query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.job_status. Fixed GraphQL document for job_status remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --job-id
    query knowledge-base-search - Planned fixed Monday knowledge_base_search query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.knowledge_base_search. Fixed GraphQL document for knowledge_base_search remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --query, --limit
    query managed-column - Planned fixed Monday managed_column query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.managed_column. Fixed GraphQL document for managed_column remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query marketplace-app-discounts - Planned fixed Monday marketplace_app_discounts query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.marketplace_app_discounts. Fixed GraphQL document for marketplace_app_discounts remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --app-id
    query me - Planned fixed Monday me query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.me. Fixed GraphQL document for me remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query mute-board-settings - Planned fixed Monday mute_board_settings query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.mute_board_settings. Blocked on connector-local schema for complex GraphQL variables; no raw GraphQL escape hatch. Also blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation.
    query next-items-page - Planned fixed Monday next_items_page query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.next_items_page. Fixed GraphQL document for next_items_page remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --cursor, --limit
    query notetaker - Planned fixed Monday notetaker query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.notetaker. Fixed GraphQL document for notetaker remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query notifications - Planned fixed Monday notifications query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.notifications. Fixed GraphQL document for notifications remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --filter-read
    query notifications-settings - Planned fixed Monday notifications_settings query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.notifications_settings. Blocked on connector-local schema for complex GraphQL variables; no raw GraphQL escape hatch. Also blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation.
    query object-relations - Planned fixed Monday object_relations query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.object_relations. Fixed GraphQL document for object_relations remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --object-id
    query object-types-unique-keys - Planned fixed Monday object_types_unique_keys query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.object_types_unique_keys. Fixed GraphQL document for object_types_unique_keys remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query objects - Planned fixed Monday objects query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.objects. Fixed GraphQL document for objects remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --limit
    query platform-api - Planned fixed Monday platform_api query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.platform_api. Fixed GraphQL document for platform_api remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query replies - Planned fixed Monday replies query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.replies. Blocked on connector-local schema for complex GraphQL variables; no raw GraphQL escape hatch. Also blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation.
    query search - Planned fixed Monday search query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.search. Fixed GraphQL document for search remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query template-installation-status - Planned fixed Monday template_installation_status query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.template_installation_status. Fixed GraphQL document for template_installation_status remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --process-id
    query timeline - Planned fixed Monday timeline query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.timeline. Fixed GraphQL document for timeline remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --id
    query timeline-item - Planned fixed Monday timeline_item query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.timeline_item. Fixed GraphQL document for timeline_item remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --id
    query updates - Planned fixed Monday updates query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.updates. Fixed GraphQL document for updates remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --limit, --to-date, --from-date
    query user-configs - Planned fixed Monday user_configs query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.user_configs. Fixed GraphQL document for user_configs remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query validations - Planned fixed Monday validations query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.validations. Fixed GraphQL document for validations remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --id
    query version - Planned fixed Monday version query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.version. Fixed GraphQL document for version remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query versions - Planned fixed Monday versions query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.versions. Fixed GraphQL document for versions remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.
    query webhooks - Planned fixed Monday webhooks query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.webhooks. Fixed GraphQL document for webhooks remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --board-id
    query workspaces - Planned fixed Monday workspaces query [intent=direct_read availability=planned]; approval: none; risk: planned bounded GraphQL read; blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation; notes: Planned operation monday.query.workspaces. Fixed GraphQL document for workspaces remains in operations.json; execution is blocked by shared OperationDirectRead GraphQL errors[] failure semantics and duplicate POST / endpoint classifier validation. No raw query text is accepted.; flags: --ids
  Reverse ETL GraphQL mutations
    reverse activate-form - Planned Monday activate_form mutation [intent=reverse_etl availability=planned]; approval: blocked until a non-persistent stdin/env input path exists; no persistent CLI flag execution; risk: planned medium mutation; notes: Planned/blocked because redacted form token must not be exposed as a persistent CLI flag.
    ...
    reverse create-doc-block - Plan and execute Monday create_doc_block [intent=reverse_etl availability=implemented write=create_doc_block]; approval: reverse ETL plan, preview, explicit approval, execute; risk: high: runs Monday mutation create_doc_block; reverse ETL approval required; notes: Fixed GraphQL mutation document for create_doc_block; no raw query text is accepted.; flags: --doc-id, --after-block-id, --content
    ...
    reverse create-portfolio - Planned Monday create_portfolio mutation [intent=reverse_etl availability=planned]; approval: blocked until a non-persistent stdin/env input path exists; no persistent CLI flag execution; risk: planned high mutation; notes: Planned/blocked because redacted callback URL must not be exposed as a persistent CLI flag.
    ...
    reverse create-webhook - Planned Monday create_webhook mutation [intent=reverse_etl availability=planned]; approval: blocked until a non-persistent stdin/env input path exists; no persistent CLI flag execution; risk: planned high mutation; notes: Planned/blocked because redacted webhook URL must not be exposed as a persistent CLI flag.
    ...
    reverse deactivate-form - Planned Monday deactivate_form mutation [intent=reverse_etl availability=planned]; approval: blocked until a non-persistent stdin/env input path exists; no persistent CLI flag execution; risk: planned critical mutation; notes: Planned/blocked because redacted form token must not be exposed as a persistent CLI flag.
    ...
    reverse delete-question - Planned Monday delete_question mutation [intent=reverse_etl availability=planned]; approval: blocked until a non-persistent stdin/env input path exists; no persistent CLI flag execution; risk: planned critical mutation; notes: Planned/blocked because redacted form token must not be exposed as a persistent CLI flag.
    ...
    reverse remove-mock-app-subscription - Planned Monday remove_mock_app_subscription mutation [intent=reverse_etl availability=planned]; approval: blocked until a non-persistent stdin/env input path exists; no persistent CLI flag execution; risk: planned critical mutation; notes: Planned/blocked because redacted partial signing secret must not be exposed as a persistent CLI flag.
    ...
    reverse set-mock-app-subscription - Planned Monday set_mock_app_subscription mutation [intent=reverse_etl availability=planned]; approval: blocked until a non-persistent stdin/env input path exists; no persistent CLI flag execution; risk: planned high mutation; notes: Planned/blocked because redacted partial signing secret must not be exposed as a persistent CLI flag.
    ...
    reverse shorten-form-url - Planned Monday shorten_form_url mutation [intent=reverse_etl availability=planned]; approval: blocked until a non-persistent stdin/env input path exists; no persistent CLI flag execution; risk: planned medium mutation; notes: Planned/blocked because redacted form token must not be exposed as a persistent CLI flag.
    ...
    reverse update-doc-block - Plan and execute Monday update_doc_block [intent=reverse_etl availability=implemented write=update_doc_block]; approval: reverse ETL plan, preview, explicit approval, execute; risk: high: runs Monday mutation update_doc_block; reverse ETL approval required; notes: Fixed GraphQL mutation document for update_doc_block; no raw query text is accepted.; flags: --block-id, --content
