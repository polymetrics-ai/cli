# pm connectors inspect source-sap-fieldglass

```text
NAME
  pm connectors inspect source-sap-fieldglass - SAP Fieldglass connector manual

SYNOPSIS
  pm connectors inspect source-sap-fieldglass
  pm connectors inspect source-sap-fieldglass --json
