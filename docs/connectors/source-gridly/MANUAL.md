# pm connectors inspect source-gridly

```text
NAME
  pm connectors inspect source-gridly - Gridly connector manual

SYNOPSIS
  pm connectors inspect source-gridly
  pm connectors inspect source-gridly --json
  pm credentials add <name> --connector source-gridly [--config key=value] [--from-env field=ENV] [--value-stdin field]
