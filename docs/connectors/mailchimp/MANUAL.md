...
COMMAND SURFACE
  ...
  Approval-gated reverse ETL actions
    ...
    actions patch-lists - Update lists [intent=reverse_etl availability=implemented write=patch_lists]; approval: reverse ETL plan -> preview -> explicit approval -> execute; risk: Externally visible Mailchimp mutation: Update lists. Reverse ETL must plan, preview, receive explicit approval, and then execute.; flags: --list-id (non-empty)
  ...
  Other Commands
    ...
    operations get - Declared direct read: GET /. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getroot-1 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations post-automations-workflow-id-emails - Declared direct write: POST /automations/{workflow_id}/emails. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.postcampaignsidactionsunschedule-22 has no declaration-owned executable direct_write route.
    operations post-automations-workflow-id-emails-workflow-email-id - Declared direct write: POST /automations/{workflow_id}/emails/{workflow_email_id}. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.postcampaignsidactionstest-23 has no declaration-owned executable direct_write route.
    operations get-automations-workflow-id-emails-workflow-email-id-actions-start - Declared direct read: GET /automations/{workflow_id}/emails/{workflow_email_id}/actions/start. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getcampaignsidcontent-25 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations put-automations-workflow-id-emails-workflow-email-id-actions-start - Declared direct write: PUT /automations/{workflow_id}/emails/{workflow_email_id}/actions/start. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.putcampaignsidcontent-26 has no declaration-owned executable direct_write route.
    operations post-automations-workflow-id-emails-workflow-email-id-queue-subscriber-hash - Declared direct write: POST /automations/{workflow_id}/emails/{workflow_email_id}/queue/{subscriber_hash}. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.postcampaignsidactionsresume-28 has no declaration-owned executable direct_write route.
    operations delete-automations-workflow-id-removed-subscribers-subscriber-hash - Declared direct write: DELETE /automations/{workflow_id}/removed-subscribers/{subscriber_hash}. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute with destructive confirmation; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.deletecampaignsidfeedbackid-31 has no declaration-owned executable direct_write route.
    operations patch-automations-workflow-id-removed-subscribers-subscriber-hash - Declared direct write: PATCH /automations/{workflow_id}/removed-subscribers/{subscriber_hash}. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.patchcampaignsidfeedbackid-33 has no declaration-owned executable direct_write route.
    operations delete-batch-webhooks - Declared direct write: DELETE /batch-webhooks. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute with destructive confirmation; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.deleteconnectedsitesid-34 has no declaration-owned executable direct_write route.
    operations post-batch-webhooks-batch-webhook-id - Declared direct write: POST /batch-webhooks/{batch_webhook_id}. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.postconnectedsitesidactionsverifyscriptinstallation-36 has no declaration-owned executable direct_write route.
    operations post-batches-batch-id - Declared direct write: POST /batches/{batch_id}. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.postconnectedsites-39 has no declaration-owned executable direct_write route.
    operations get-campaigns-campaign-id-actions-create-resend - Declared direct read: GET /campaigns/{campaign_id}/actions/create-resend. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getlistsidabusereports-45 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations get-campaigns-campaign-id-actions-pause - Declared direct read: GET /campaigns/{campaign_id}/actions/pause. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getlists-46 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations get-campaigns-campaign-id-actions-replicate - Declared direct read: GET /campaigns/{campaign_id}/actions/replicate. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getfilemanagerfiles-48 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations delete-campaigns-campaign-id-actions-resume - Declared direct write: DELETE /campaigns/{campaign_id}/actions/resume. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute with destructive confirmation; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.deletelistsid-50 has no declaration-owned executable direct_write route.
    operations get-campaigns-campaign-id-actions-resume - Declared direct read: GET /campaigns/{campaign_id}/actions/resume. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getlistsid-51 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations patch-campaigns-campaign-id-actions-resume - Declared direct write: PATCH /campaigns/{campaign_id}/actions/resume. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.patchlistsid-52 has no declaration-owned executable direct_write route.
    operations get-campaigns-campaign-id-actions-schedule - Declared direct read: GET /campaigns/{campaign_id}/actions/schedule. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getfilemanagerfolders-54 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations delete-campaigns-campaign-id-actions-send - Declared direct write: DELETE /campaigns/{campaign_id}/actions/send. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute with destructive confirmation; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.deletefilemanagerfilesid-56 has no declaration-owned executable direct_write route.
    operations get-campaigns-campaign-id-actions-send - Declared direct read: GET /campaigns/{campaign_id}/actions/send. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getfilemanagerfilesid-57 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations patch-campaigns-campaign-id-actions-send - Declared direct write: PATCH /campaigns/{campaign_id}/actions/send. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.patchfilemanagerfilesid-58 has no declaration-owned executable direct_write route.
    operations get-campaigns-campaign-id-actions-test - Declared direct read: GET /campaigns/{campaign_id}/actions/test. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getfilemanagerfoldersfiles-59 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations delete-campaigns-campaign-id-actions-unschedule - Declared direct write: DELETE /campaigns/{campaign_id}/actions/unschedule. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute with destructive confirmation; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.deletefilemanagerfoldersid-60 has no declaration-owned executable direct_write route.
    operations get-campaigns-campaign-id-actions-unschedule - Declared direct read: GET /campaigns/{campaign_id}/actions/unschedule. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getfilemanagerfoldersid-61 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations patch-campaigns-campaign-id-actions-unschedule - Declared direct write: PATCH /campaigns/{campaign_id}/actions/unschedule. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.patchfilemanagerfoldersid-62 has no declaration-owned executable direct_write route.
    operations get-connected-sites-connected-site-id-actions-disable-pixel - Declared direct read: GET /connected-sites/{connected_site_id}/actions/disable-pixel. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.previewasegment-73 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations get-ping - Declared direct read: GET /ping. [intent=direct_read availability=partial]; notes: Blocked: locked source operation mailchimp.provider.getping-236 has no declaration-owned executable stream, direct-read, binary, or status route.; flags: --page, --page-cursor
    operations post-template-folders-folder-id - Declared direct write: POST /template-folders/{folder_id}. [intent=direct_write availability=partial]; approval: direct_write commands require plan, preview, approval, execute; risk: Documented provider operation has no connector-owned operation contract, command, or CLI surface. It remains declaration-pending rather than being treated as an engine gap.; notes: Blocked: locked source operation mailchimp.provider.postconnectedsitesidactionsdisablepixel-284 has no declaration-owned executable direct_write route.
  Help topics:
