# pm connectors inspect source-openfda

```text
NAME
  pm connectors inspect source-openfda - OpenFDA connector manual

SYNOPSIS
  pm connectors inspect source-openfda
  pm connectors inspect source-openfda --json
  pm credentials add <name> --connector source-openfda [--config key=value] [--from-env field=ENV] [--value-stdin field]
