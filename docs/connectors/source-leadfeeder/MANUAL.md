# pm connectors inspect source-leadfeeder

```text
NAME
  pm connectors inspect source-leadfeeder - Leadfeeder connector manual

SYNOPSIS
  pm connectors inspect source-leadfeeder
  pm connectors inspect source-leadfeeder --json
  pm credentials add <name> --connector source-leadfeeder [--config key=value] [--from-env field=ENV] [--value-stdin field]
