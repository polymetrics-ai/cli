...
```text
NAME
  pm connectors inspect source-close-com - Close.com connector manual

SYNOPSIS
  pm connectors inspect source-close-com
  pm connectors inspect source-close-com --json
  pm credentials add <name> --connector source-close-com [--config key=value] [--from-env field=ENV] [--value-stdin field]
