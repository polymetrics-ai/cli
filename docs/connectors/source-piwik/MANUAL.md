# pm connectors inspect source-piwik

```text
NAME
  pm connectors inspect source-piwik - Piwik connector manual

SYNOPSIS
  pm connectors inspect source-piwik
  pm connectors inspect source-piwik --json
  pm credentials add <name> --connector source-piwik [--config key=value] [--from-env field=ENV] [--value-stdin field]
...
CONFIGURATION
  ...
  organization_id (string) required: The organization id appearing at URL of your piwik website
