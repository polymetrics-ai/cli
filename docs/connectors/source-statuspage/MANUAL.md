# pm connectors inspect source-statuspage

```text
NAME
  pm connectors inspect source-statuspage - Statuspage connector manual

SYNOPSIS
  pm connectors inspect source-statuspage
  pm connectors inspect source-statuspage --json
