...
DESCRIPTION
  SFTP-JSON catalog connector for https://docs.airbyte.com/integrations/destinations/sftp-json. Native implementation status: planned_native_port.
...
IMPLEMENTATION STATUS
  ...
  upstream image reference: airbyte/destination-sftp-json:0.2.15 (metadata only; not executed)
...
OFFICIAL APPLICATION DOCUMENTATION
  ...
  Airbyte connector documentation: https://docs.airbyte.com/integrations/destinations/sftp-json
...
DOCUMENTATION
  https://docs.airbyte.com/integrations/destinations/sftp-json
...
SEE ALSO
  SFTP-JSON documentation: https://docs.airbyte.com/integrations/destinations/sftp-json
