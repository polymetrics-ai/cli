# pm connectors inspect source-google-calendar

```text
NAME
  pm connectors inspect source-google-calendar - Google Calendar connector manual

SYNOPSIS
  pm connectors inspect source-google-calendar
  pm connectors inspect source-google-calendar --json
  pm credentials add <name> --connector source-google-calendar [--config key=value] [--from-env field=ENV] [--value-stdin field]
