...
- Other Commands
  - operations get-advertiser-info - Declared etl: GET /advertiser/info/. [intent=etl availability=implemented stream=advertisers]; notes: Provider GET /advertiser/info/ is bound to the existing advertisers stream with its connector-owned schema and pagination contract.
  - operations get-campaign-get - Declared etl: GET /campaign/get/. [intent=etl availability=implemented stream=campaigns]; notes: Provider GET /campaign/get/ is bound to the existing campaigns stream with its connector-owned schema and pagination contract.
  - operations get-adgroup-get - Declared etl: GET /adgroup/get/. [intent=etl availability=implemented stream=adgroups]; notes: Provider GET /adgroup/get/ is bound to the existing adgroups stream with its connector-owned schema and pagination contract.
  - operations get-ad-get - Declared etl: GET /ad/get/. [intent=etl availability=implemented stream=ads]; notes: Provider GET /ad/get/ is bound to the existing ads stream with its connector-owned schema and pagination contract.
