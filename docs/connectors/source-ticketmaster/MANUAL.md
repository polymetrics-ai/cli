# pm connectors inspect source-ticketmaster

```text
NAME
  pm connectors inspect source-ticketmaster - Ticketmaster connector manual

SYNOPSIS
  pm connectors inspect source-ticketmaster
  pm connectors inspect source-ticketmaster --json
