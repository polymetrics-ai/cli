# pm connectors inspect source-brex

```text
NAME
  pm connectors inspect source-brex - Brex connector manual

SYNOPSIS
  pm connectors inspect source-brex
  pm connectors inspect source-brex --json
...
CONFIGURATION
  ...
  user_token (string) required secret: User token to authenticate API requests. Generate it from your Brex dashboard under Developer > Settings.
