# pm connectors inspect source-gorgias

```text
NAME
  pm connectors inspect source-gorgias - Gorgias connector manual

SYNOPSIS
  pm connectors inspect source-gorgias
  pm connectors inspect source-gorgias --json
  pm credentials add <name> --connector source-gorgias [--config key=value] [--from-env field=ENV] [--value-stdin field]
