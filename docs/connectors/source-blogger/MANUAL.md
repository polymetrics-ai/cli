# pm connectors inspect source-blogger

```text
NAME
  pm connectors inspect source-blogger - Blogger connector manual

SYNOPSIS
  pm connectors inspect source-blogger
  pm connectors inspect source-blogger --json
  pm credentials add <name> --connector source-blogger [--config key=value] [--from-env field=ENV] [--value-stdin field]
