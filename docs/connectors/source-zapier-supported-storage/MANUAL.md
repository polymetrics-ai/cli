# pm connectors inspect source-zapier-supported-storage

```text
NAME
  pm connectors inspect source-zapier-supported-storage - Zapier Supported Storage connector manual

SYNOPSIS
  pm connectors inspect source-zapier-supported-storage
  pm connectors inspect source-zapier-supported-storage --json
