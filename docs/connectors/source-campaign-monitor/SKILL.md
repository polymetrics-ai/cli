---
name: pm-source-campaign-monitor
description: Campaign Monitor connector knowledge and safe action guide.
---

# pm-source-campaign-monitor
...
```bash
pm connectors inspect source-campaign-monitor
```

### Inspect as JSON

```bash
pm connectors inspect source-campaign-monitor --json
```
