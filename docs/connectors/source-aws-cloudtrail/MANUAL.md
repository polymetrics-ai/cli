...
```text
NAME
  pm connectors inspect source-aws-cloudtrail - Aws Cloudtrail connector manual

SYNOPSIS
  pm connectors inspect source-aws-cloudtrail
  pm connectors inspect source-aws-cloudtrail --json
  pm credentials add <name> --connector source-aws-cloudtrail [--config key=value] [--from-env field=ENV] [--value-stdin field]
