...
ETL STREAMS
  list_sites:
    primary key: id
    fields: address(), created_at(), deleted_at(), features(), id(), mode(), object(), public_api_key(), settings(), subdomain(), updated_at()
  get_site:
    primary key: id
    fields: address(), created_at(), deleted_at(), features(), id(), mode(), object(), public_api_key(), settings(), subdomain(), updated_at()
  accounts:
  ...
  get_account:
    primary key: id
    fields: address(), bill_date(), bill_to(), billing_info(), cc_emails(), code(), company(), created_at(), custom_fields(), deleted_at(), dunning_campaign_id(), email(), entity_use_code(), exemption_certificate(), external_accounts(), first_name(), has_active_subscription(), has_canceled_subscription(), has_future_subscription(), has_live_subscription(), has_past_due_invoice(), has_paused_subscription(), hosted_login_token(), id(), invoice_template_id(), last_name(), object(), override_business_entity_id(), parent_account_id(), preferred_locale(), preferred_time_zone(), shipping_addresses(), state(), tax_exempt(), updated_at(), username(), vat_number()
  get_account_acquisition:
    primary key: id
    fields: account(), acquired_at(), campaign(), channel(), cost(), created_at(), id(), object(), subchannel(), updated_at()
  get_account_balance:
    primary key: account_id
    fields: account(), account_id(), balances(), object(), past_due()
  get_billing_info:
    primary key: id
    fields: account_id(), address(), backup_payment_method(), company(), created_at(), first_name(), fraud(), id(), last_name(), object(), payment_gateway_references(), payment_method(), primary_payment_method(), updated_at(), updated_by(), valid(), vat_number()
  list_billing_infos:
    primary key: id
    fields: account_id(), address(), backup_payment_method(), company(), created_at(), first_name(), fraud(), id(), last_name(), object(), payment_gateway_references(), payment_method(), primary_payment_method(), updated_at(), updated_by(), valid(), vat_number()
  get_a_billing_info:
  ...
  list_account_coupon_redemptions:
    primary key: id
    fields: account(), coupon(), created_at(), currency(), discounted(), id(), object(), remaining_duration(), removed_at(), state(), subscription_id(), updated_at(), uuid()
  ...
  list_account_credit_payments:
    primary key: id
    fields: account(), action(), amount(), applied_to_invoice(), created_at(), currency(), id(), object(), original_credit_payment_id(), original_invoice(), refund_transaction(), updated_at(), uuid(), voided_at()
  list_account_external_account:
    primary key: id
    fields: created_at(), external_account_code(), external_connection_type(), id(), object(), updated_at()
  get_account_external_account:
    primary key: id
    fields: created_at(), external_account_code(), external_connection_type(), id(), object(), updated_at()
  list_account_external_invoices:
    primary key: id
    fields: account(), created_at(), currency(), external_id(), external_subscription(), id(), line_items(), object(), purchased_at(), state(), total(), updated_at()
  list_account_invoices:
    primary key: id
    fields: account(), address(), balance(), billing_info_id(), business_entity_id(), closed_at(), collection_method(), coupon_redemptions(), created_at(), credit_payments(), currency(), custom_fields(), customer_notes(), discount(), due_at(), dunning_campaign_id(), dunning_events_sent(), final_dunning_event(), has_more_line_items(), id(), line_items(), net_terms(), net_terms_type(), number(), object(), origin(), paid(), po_number(), previous_invoice_id(), reference_only_currency_conversion(), refundable_amount(), shipping_address(), state(), subscription_ids(), subtotal(), subtotal_after_discount(), tax(), tax_info(), terms_and_conditions(), total(), transactions(), type(), updated_at(), used_tax_service(), uuid(), vat_number(), vat_reverse_charge_notes()
  list_account_line_items:
    primary key: id
    fields: account(), accounting_code(), add_on_code(), add_on_id(), amount(), avalara_service_type(), avalara_transaction_type(), bill_for_account_id(), created_at(), credit_applied(), credit_reason_code(), currency(), custom_fields(), description(), destination_tax_address_source(), discount(), discounts(), end_date(), external_sku(), harmonized_system_code(), id(), invoice_id(), invoice_number(), item_code(), item_id(), legacy_category(), liability_gl_account_code(), object(), origin(), origin_tax_address_source(), original_line_item_invoice_id(), performance_obligation_id(), plan_code(), plan_id(), previous_line_item_id(), product_code(), proration_rate(), quantity(), quantity_decimal(), refund(), refunded_quantity(), refunded_quantity_decimal(), revenue_gl_account_code(), revenue_schedule_type(), shipping_address(), start_date(), state(), subscription_id(), subtotal(), tax(), tax_code(), tax_exempt(), tax_inclusive(), tax_info(), taxable(), type(), unit_amount(), unit_amount_decimal(), updated_at(), uuid(), vertex_transaction_type()
  list_account_notes:
    primary key: id
    fields: account_id(), created_at(), id(), message(), object(), user()
  get_account_note:
    primary key: id
    fields: account_id(), created_at(), id(), message(), object(), user()
  list_shipping_addresses:
    primary key: id
    fields: account_id(), city(), company(), country(), created_at(), email(), first_name(), geo_code(), id(), last_name(), nickname(), object(), phone(), postal_code(), region(), street1(), street2(), updated_at(), vat_number()
  get_shipping_address:
    primary key: id
    fields: account_id(), city(), company(), country(), created_at(), email(), first_name(), geo_code(), id(), last_name(), nickname(), object(), phone(), postal_code(), region(), street1(), street2(), updated_at(), vat_number()
  list_account_subscriptions:
    primary key: id
    fields: account(), action_result(), activated_at(), active_invoice_id(), add_ons(), add_ons_total(), auto_renew(), bank_account_authorized_at(), billing_info_id(), business_entity_id(), canceled_at(), collection_method(), converted_at(), coupon_redemptions(), created_at(), credit_application_policy(), currency(), current_period_ends_at(), current_period_started_at(), current_term_ends_at(), current_term_started_at(), custom_fields(), customer_notes(), expiration_reason(), expires_at(), gateway_code(), id(), net_terms(), net_terms_type(), object(), paused_at(), pending_change(), plan(), po_number(), price_segment_id(), quantity(), ramp_intervals(), remaining_billing_cycles(), remaining_pause_cycles(), renewal_billing_cycles(), resume_at(), revenue_schedule_type(), shipping(), started_with_gift(), state(), subtotal(), tax(), tax_inclusive(), tax_info(), terms_and_conditions(), total(), total_billing_cycles(), trial_ends_at(), trial_started_at(), unit_amount(), updated_at(), uuid()
  list_account_transactions:
    primary key: id
    fields: account(), action_result(), amount(), avs_check(), backup_payment_method_used(), billing_address(), collected_at(), collection_method(), created_at(), currency(), customer_message(), customer_message_locale(), cvv_check(), description(), fraud_info(), gateway_approval_code(), gateway_message(), gateway_reference(), gateway_response_code(), gateway_response_time(), gateway_response_values(), id(), initiator(), invoice(), ip_address_country(), ip_address_v4(), merchant_reason_code(), next_action(), object(), origin(), original_transaction_id(), payment_gateway(), payment_method(), refunded(), status(), status_code(), status_message(), subscription_ids(), success(), type(), updated_at(), uuid(), vat_number(), voided_at(), voided_by_invoice()
  list_child_accounts:
    primary key: id
    fields: address(), bill_date(), bill_to(), billing_info(), cc_emails(), code(), company(), created_at(), custom_fields(), deleted_at(), dunning_campaign_id(), email(), entity_use_code(), exemption_certificate(), external_accounts(), first_name(), has_active_subscription(), has_canceled_subscription(), has_future_subscription(), has_live_subscription(), has_past_due_invoice(), has_paused_subscription(), hosted_login_token(), id(), invoice_template_id(), last_name(), object(), override_business_entity_id(), parent_account_id(), preferred_locale(), preferred_time_zone(), shipping_addresses(), state(), tax_exempt(), updated_at(), username(), vat_number()
  ...
  list_coupons:
    primary key: id
    fields: applies_to_all_items(), applies_to_all_plans(), applies_to_non_plan_charges(), code(), coupon_type(), created_at(), discount(), duration(), expired_at(), free_trial_amount(), free_trial_unit(), hosted_page_description(), id(), invoice_description(), items(), max_redemptions(), max_redemptions_per_account(), name(), object(), plans(), redeem_by(), redemption_resource(), state(), temporal_amount(), temporal_unit(), unique_code_template(), unique_coupon_code(), unique_coupon_codes_count(), updated_at()
  get_coupon:
    primary key: id
    fields: applies_to_all_items(), applies_to_all_plans(), applies_to_non_plan_charges(), code(), coupon_type(), created_at(), discount(), duration(), expired_at(), free_trial_amount(), free_trial_unit(), hosted_page_description(), id(), invoice_description(), items(), max_redemptions(), max_redemptions_per_account(), name(), object(), plans(), redeem_by(), redemption_resource(), state(), temporal_amount(), temporal_unit(), unique_code_template(), unique_coupon_code(), unique_coupon_codes_count(), updated_at()
  list_unique_coupon_codes:
    primary key: id
    fields: bulk_coupon_code(), bulk_coupon_id(), code(), created_at(), expired_at(), id(), object(), redeemed_at(), state(), updated_at()
  ...
  list_custom_field_definitions:
    primary key: id
    fields: created_at(), deleted_at(), display_name(), id(), name(), object(), related_type(), tooltip(), updated_at(), user_access()
  get_custom_field_definition:
    primary key: id
    fields: created_at(), deleted_at(), display_name(), id(), name(), object(), related_type(), tooltip(), updated_at(), user_access()
  list_general_ledger_accounts:
    primary key: id
    fields: account_type(), code(), created_at(), description(), id(), object(), updated_at()
  ...
  list_items:
    primary key: id
    fields: accounting_code(), avalara_service_type(), avalara_transaction_type(), code(), created_at(), currencies(), custom_fields(), deleted_at(), description(), external_sku(), harmonized_system_code(), id(), liability_gl_account_id(), name(), object(), performance_obligation_id(), revenue_gl_account_id(), revenue_schedule_type(), state(), tax_code(), tax_exempt(), updated_at()
  get_item:
    primary key: id
    fields: accounting_code(), avalara_service_type(), avalara_transaction_type(), code(), created_at(), currencies(), custom_fields(), deleted_at(), description(), external_sku(), harmonized_system_code(), id(), liability_gl_account_id(), name(), object(), performance_obligation_id(), revenue_gl_account_id(), revenue_schedule_type(), state(), tax_code(), tax_exempt(), updated_at()
  list_measured_unit:
    primary key: id
    fields: created_at(), deleted_at(), description(), display_name(), id(), name(), object(), state(), updated_at()
  get_measured_unit:
    primary key: id
    fields: created_at(), deleted_at(), description(), display_name(), id(), name(), object(), state(), updated_at()
  list_external_products:
    primary key: id
    fields: created_at(), external_product_references(), id(), name(), object(), plan(), updated_at()
  get_external_product:
    primary key: id
    fields: created_at(), external_product_references(), id(), name(), object(), plan(), updated_at()
  list_external_product_external_product_references:
    primary key: id
    fields: created_at(), external_connection_type(), id(), object(), reference_code(), updated_at()
  get_external_product_external_product_reference:
    primary key: id
    fields: created_at(), external_connection_type(), id(), object(), reference_code(), updated_at()
  list_external_subscriptions:
    primary key: id
    fields: account(), activated_at(), app_identifier(), auto_renew(), canceled_at(), created_at(), expires_at(), external_id(), external_payment_phases(), external_product_reference(), id(), imported(), in_grace_period(), last_purchased(), object(), quantity(), state(), test(), trial_ends_at(), trial_started_at(), updated_at(), uuid()
  ...
  get_plan:
    primary key: id
    fields: accounting_code(), allow_any_item_on_subscriptions(), auto_renew(), avalara_service_type(), avalara_transaction_type(), code(), created_at(), currencies(), custom_fields(), deleted_at(), description(), dunning_campaign_id(), harmonized_system_code(), hosted_pages(), id(), interval_length(), interval_unit(), liability_gl_account_id(), name(), object(), performance_obligation_id(), pricing_model(), ramp_intervals(), revenue_gl_account_id(), revenue_schedule_type(), setup_fee_accounting_code(), setup_fee_liability_gl_account_id(), setup_fee_performance_obligation_id(), setup_fee_revenue_gl_account_id(), setup_fee_revenue_schedule_type(), setup_fees(), state(), tax_code(), tax_exempt(), total_billing_cycles(), trial_length(), trial_requires_billing_info(), trial_unit(), updated_at(), vertex_transaction_type()
  list_plan_add_ons:
    primary key: id
    fields: accounting_code(), add_on_type(), avalara_service_type(), avalara_transaction_type(), code(), created_at(), currencies(), default_quantity(), deleted_at(), display_quantity(), external_sku(), harmonized_system_code(), id(), item(), liability_gl_account_id(), measured_unit_id(), name(), object(), optional(), percentage_tiers(), performance_obligation_id(), plan_id(), revenue_gl_account_id(), revenue_schedule_type(), state(), tax_code(), tier_type(), tiers(), updated_at(), usage_calculation_type(), usage_percentage(), usage_timeframe(), usage_type()
  get_plan_add_on:
    primary key: id
    fields: accounting_code(), add_on_type(), avalara_service_type(), avalara_transaction_type(), code(), created_at(), currencies(), default_quantity(), deleted_at(), display_quantity(), external_sku(), harmonized_system_code(), id(), item(), liability_gl_account_id(), measured_unit_id(), name(), object(), optional(), percentage_tiers(), performance_obligation_id(), plan_id(), revenue_gl_account_id(), revenue_schedule_type(), state(), tax_code(), tier_type(), tiers(), updated_at(), usage_calculation_type(), usage_percentage(), usage_timeframe(), usage_type()
  list_price_segments:
    primary key: id
    fields: code(), id(), object()
  get_price_segment:
    primary key: id
    fields: code(), id(), object()
  list_add_ons:
  ...
  list_shipping_methods:
    primary key: id
    fields: accounting_code(), code(), created_at(), deleted_at(), id(), liability_gl_account_id(), name(), object(), performance_obligation_id(), revenue_gl_account_id(), tax_code(), updated_at()
  get_shipping_method:
    primary key: id
    fields: accounting_code(), code(), created_at(), deleted_at(), id(), liability_gl_account_id(), name(), object(), performance_obligation_id(), revenue_gl_account_id(), tax_code(), updated_at()
  subscriptions:
  ...
  get_subscription_change:
    primary key: id
    fields: activate_at(), activated(), add_ons(), billing_info(), business_entity(), created_at(), custom_fields(), deleted_at(), id(), invoice_collection(), next_bill_date(), object(), plan(), quantity(), ramp_intervals(), revenue_schedule_type(), shipping(), subscription_id(), tax_inclusive(), unit_amount(), updated_at()
  ...
  list_usage:
    primary key: id
    fields: amount(), billed_at(), created_at(), id(), measured_unit_id(), merchant_tag(), object(), percentage_tiers(), recording_timestamp(), tier_type(), tiers(), unit_amount(), unit_amount_decimal(), updated_at(), usage_percentage(), usage_timestamp(), usage_type()
  get_usage:
    primary key: id
    fields: amount(), billed_at(), created_at(), id(), measured_unit_id(), merchant_tag(), object(), percentage_tiers(), recording_timestamp(), tier_type(), tiers(), unit_amount(), unit_amount_decimal(), updated_at(), usage_percentage(), usage_timestamp(), usage_type()
  transactions:
  ...
  list_dunning_campaigns:
    primary key: id
    fields: code(), created_at(), default_campaign(), deleted_at(), description(), dunning_cycles(), id(), name(), object(), updated_at()
  get_dunning_campaign:
    primary key: id
    fields: code(), created_at(), default_campaign(), deleted_at(), description(), dunning_cycles(), id(), name(), object(), updated_at()
  list_invoice_templates:
    primary key: id
    fields: code(), created_at(), description(), id(), name(), updated_at()
  ...
  list_external_subscription_external_payment_phases:
    primary key: id
    fields: amount(), created_at(), currency(), ending_billing_period_index(), ends_at(), id(), object(), offer_name(), offer_type(), period_count(), period_length(), started_at(), starting_billing_period_index(), updated_at()
  get_external_subscription_external_payment_phase:
    primary key: id
    fields: amount(), created_at(), currency(), ending_billing_period_index(), ends_at(), id(), object(), offer_name(), offer_type(), period_count(), period_length(), started_at(), starting_billing_period_index(), updated_at()
  list_entitlements:
    primary key: customer_permission_id
    fields: created_at(), customer_permission(), customer_permission_id(), granted_by(), object(), updated_at()
  list_account_external_subscriptions:
    primary key: id
    fields: account(), activated_at(), app_identifier(), auto_renew(), canceled_at(), created_at(), expires_at(), external_id(), external_payment_phases(), external_product_reference(), id(), imported(), in_grace_period(), last_purchased(), object(), quantity(), state(), test(), trial_ends_at(), trial_started_at(), updated_at(), uuid()
  get_business_entity:
    primary key: id
    fields: code(), created_at(), default_liability_gl_account_id(), default_registration_number(), default_revenue_gl_account_id(), default_vat_number(), destination_tax_address_source(), id(), invoice_display_address(), name(), object(), origin_tax_address_source(), subscriber_location_countries(), tax_address(), updated_at()
  list_business_entities:
    primary key: id
    fields: code(), created_at(), default_liability_gl_account_id(), default_registration_number(), default_revenue_gl_account_id(), default_vat_number(), destination_tax_address_source(), id(), invoice_display_address(), name(), object(), origin_tax_address_source(), subscriber_location_countries(), tax_address(), updated_at()
  list_gift_cards:
    primary key: id
    fields: balance(), canceled_at(), created_at(), currency(), delivered_at(), delivery(), gifter_account_id(), id(), liability_gl_account_id(), object(), performance_obligation_id(), product_code(), purchase_invoice_id(), recipient_account_id(), redeemed_at(), redemption_code(), redemption_invoice_id(), revenue_gl_account_id(), unit_amount(), updated_at()
  get_gift_card:
    primary key: id
    fields: balance(), canceled_at(), created_at(), currency(), delivered_at(), delivery(), gifter_account_id(), id(), liability_gl_account_id(), object(), performance_obligation_id(), product_code(), purchase_invoice_id(), recipient_account_id(), redeemed_at(), redemption_code(), redemption_invoice_id(), revenue_gl_account_id(), unit_amount(), updated_at()
...
REVERSE ETL ACTIONS
  ...
  terminate_subscription:
    ...
    required fields: subscription_id, refund
    risk: critical — Recurly supports provider idempotency for POST/PUT/DELETE through the Idempotency-Key header; keep reverse ETL in plan/preview/approve/execute and the runtime binds one fresh key to each approved record and reuses it only for that record's automatic retries.
  cancel_subscription:
