...
COMMAND SURFACE
  ...
  Other Commands
    ...
    invoices preview - Preview new invoice for pending line items [intent=direct_read availability=implemented operation=preview_invoice]; notes: Bounded Recurly read/preview operation; fixed method and path, typed request fields, and redacted JSON output.; flags: --account-id, --currency
    ...
    purchases preview - Preview a new purchase [intent=direct_read availability=implemented operation=preview_purchase]; notes: Bounded Recurly read/preview operation; fixed method and path, typed request fields, and redacted JSON output.; flags: --currency, --account-code
    ...
    gift cards preview - Preview gift card [intent=direct_read availability=implemented operation=preview_gift_card]; notes: Bounded Recurly read/preview operation; fixed method and path, typed request fields, and redacted JSON output.; flags: --product-code, --unit-amount, --currency
  Help topics:
