# pm connectors inspect source-zoho-desk

```text
NAME
  pm connectors inspect source-zoho-desk - Zoho Desk connector manual

SYNOPSIS
  pm connectors inspect source-zoho-desk
  pm connectors inspect source-zoho-desk --json
  pm credentials add <name> --connector source-zoho-desk [--config key=value] [--from-env field=ENV] [--value-stdin field]
