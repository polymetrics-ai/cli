...
- Other Commands
  ...
  - set custom field value apply - POST /customField.setValue (set_custom_field_value) [intent=reverse_etl availability=implemented write=set_custom_field_value]; approval: reverse ETL writes require plan, preview, approval, and execute.; risk: Executes Ashby customField.setValue through the documented POST /customField.setValue endpoint; reverse ETL plan, preview, approval, and execute are required.; notes: Generated from the connector-owned typed action; execution remains plan-gated.; flags: --field-id (required), --field-value (required), --object-id (required), --object-type (required)
  - set custom field values apply - POST /customField.setValues (set_custom_field_values) [intent=reverse_etl availability=implemented write=set_custom_field_values]; approval: reverse ETL writes require plan, preview, approval, and execute.; risk: Executes Ashby customField.setValues through the documented POST /customField.setValues endpoint; reverse ETL plan, preview, approval, and execute are required.; notes: Generated from the connector-owned typed action; execution remains plan-gated.; flags: --object-id (required), --object-type (required), --values-0-field-id (required), --values-0-field-value (required)
  - set user custom field value apply - POST /user.setCustomFieldValue (set_user_custom_field_value) [intent=reverse_etl availability=implemented write=set_user_custom_field_value]; approval: reverse ETL writes require plan, preview, approval, and execute.; risk: Executes Ashby user.setCustomFieldValue through the documented POST /user.setCustomFieldValue endpoint; reverse ETL plan, preview, approval, and execute are required.; notes: Generated from the connector-owned typed action; execution remains plan-gated.; flags: --field-id (required), --field-value (required), --user-id (required)
  - set user custom field values apply - POST /user.setCustomFieldValues (set_user_custom_field_values) [intent=reverse_etl availability=implemented write=set_user_custom_field_values]; approval: reverse ETL writes require plan, preview, approval, and execute.; risk: Executes Ashby user.setCustomFieldValues through the documented POST /user.setCustomFieldValues endpoint; reverse ETL plan, preview, approval, and execute are required.; notes: Generated from the connector-owned typed action; execution remains plan-gated.; flags: --user-id (required), --values-0-field-id (required), --values-0-field-value (required)
