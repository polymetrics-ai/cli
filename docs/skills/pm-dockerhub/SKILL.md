...
- Other Commands
  ...
  - audit log actions view - List audit log actions [intent=direct_read availability=implemented operation=dockerhub.auditlogs_listauditactions]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --account (required, max 4096 bytes), --page, --page-cursor
  - organization settings view - Get organization settings [intent=direct_read availability=implemented operation=dockerhub.get__v2_orgs__name__settings]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --name (required, max 4096 bytes), --page, --page-cursor
  - organization members list - List org members [intent=direct_read availability=implemented operation=dockerhub.get__v2_orgs__org_name__members]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --org-name (required, max 4096 bytes), --search (max 4096 bytes), --invites (max 4096 bytes), --type (max 4096 bytes), --role (max 4096 bytes), --page, --page-cursor
  - organization invites list - List org invites [intent=direct_read availability=implemented operation=dockerhub.get__v2_orgs__org_name__invites]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --org-name (required, max 4096 bytes), --page, --page-cursor
  - organization groups list - Get groups of an organization [intent=direct_read availability=implemented operation=dockerhub.get__v2_orgs__org_name__groups]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --org-name (required, max 4096 bytes), --username (max 4096 bytes), --search (max 4096 bytes), --page, --page-cursor
  - organization group view - Get a group of an organization [intent=direct_read availability=implemented operation=dockerhub.get__v2_orgs__org_name__groups__group_name_]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --org-name (required, max 4096 bytes), --group-name (required, max 4096 bytes), --page, --page-cursor
  - organization group members list - List members of a group [intent=direct_read availability=implemented operation=dockerhub.get__v2_orgs__org_name__groups__group_name__members]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --org-name (required, max 4096 bytes), --group-name (required, max 4096 bytes), --search (max 4096 bytes), --page, --page-cursor
  ...
  - scim resource-type view - Get a resource type [intent=direct_read availability=implemented operation=dockerhub.get__v2_scim_2.0_resourcetypes__name_]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --name (required, max 4096 bytes), --page, --page-cursor
  ...
  - scim schema view - Get a schema [intent=direct_read availability=implemented operation=dockerhub.get__v2_scim_2.0_schemas__id_]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --id (required, max 4096 bytes), --page, --page-cursor
  - scim user view - Get a user [intent=direct_read availability=implemented operation=dockerhub.get__v2_scim_2.0_users__id_]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --id (required, max 4096 bytes), --page, --page-cursor
  ...
  - personal access token view - Get personal access token [intent=direct_read availability=implemented operation=dockerhub.get__v2_access-tokens__uuid_]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --uuid (required, max 4096 bytes), --page, --page-cursor
  - organization access tokens list - List access tokens [intent=direct_read availability=implemented operation=dockerhub.get__v2_orgs__name__access-tokens]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --name (required, max 4096 bytes), --page, --page-cursor
  - organization access token view - Get access token [intent=direct_read availability=implemented operation=dockerhub.get__v2_orgs__org_name__access-tokens__access_token_id_]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --org-name (required, max 4096 bytes), --access-token-id (required, max 4096 bytes), --page, --page-cursor
  ...
  - audit logs list - List audit log events [intent=direct_read availability=implemented operation=dockerhub.auditlogs_listauditlogs]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --account (required, max 4096 bytes), --action (max 4096 bytes), --name (max 4096 bytes), --actor (max 4096 bytes), --from (max 4096 bytes), --to (max 4096 bytes), --page, --page-cursor
  - scim users list - List users [intent=direct_read availability=implemented operation=dockerhub.get__v2_scim_2.0_users]; approval: none; risk: Docker Hub provider authorization is enforced at runtime.; flags: --filter (max 4096 bytes), --attributes (max 4096 bytes), --sortOrder (max 4096 bytes), --sortBy (max 4096 bytes), --page, --page-cursor
  - scim user create - Create user [intent=direct_write availability=implemented operation=dockerhub.post__v2_scim_2.0_users]; approval: Direct writes require plan, preview, approval, and execute.; risk: Docker Hub SCIM user provisioning; direct write requires plan, preview, approval, and execute.; flags: --schemas (required, min 1 items), --user-name (required), --given-name, --family-name
  - scim user update - Update a user [intent=direct_write availability=implemented operation=dockerhub.put__v2_scim_2.0_users__id_]; approval: Direct writes require plan, preview, approval, and execute.; risk: Docker Hub SCIM user update; direct write requires plan, preview, approval, and execute.; flags: --id (required, max 4096 bytes), --schemas (required, min 1 items), --given-name, --family-name, --enabled
