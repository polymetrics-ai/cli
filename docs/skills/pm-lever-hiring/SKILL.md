...
- Bounded direct reads
  - direct retrieve-a-single-application - Retrieve a single application [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_application]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-archive-reason - Retrieve a single archive reason [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_archive_reason]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-contact - Retrieve a single contact [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_contact]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-eeo-responses-with-pii - Retrieve EEO responses with PII [intent=direct_read availability=implemented operation=lever-hiring.retrieve_eeo_responses_with_pii]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-feedback-form - Retrieve a feedback form [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_feedback_form]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-feedback-template - Retrieve a feedback template [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_feedback_template]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-interview - Retrieve a single interview [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_interview]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-note - Retrieve a single note [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_note]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-opportunity - Retrieve a single opportunity [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_opportunity]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-panel - Retrieve a single panel [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_panel]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-posting - Retrieve a single posting [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_posting]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-posting-application-questions - Retrieve posting application questions [intent=direct_read availability=implemented operation=lever-hiring.retrieve_posting_application_questions]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-profile-form - Retrieve a profile form [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_profile_form]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-profile-form-template - Retrieve a profile form template [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_profile_form_template]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-referral - Retrieve a single referral [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_referral]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-requisition - Retrieve a single requisition [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_requisition]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-requisition-field - Retrieve a single requisition field [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_requisition_field]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-stage - Retrieve a single stage [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_stage]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-diversity-survey - Retrieve a diversity survey [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_diversity_survey]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct list-all-tags - List all tags [intent=direct_read availability=implemented operation=lever-hiring.list_all_tags]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
  - direct retrieve-a-single-user - Retrieve a single user [intent=direct_read availability=implemented operation=lever-hiring.retrieve_a_single_user]; flags: --page (integer): Page number to return. Only for connectors whose declared pagination addresses pages by number (page_number, offset_limit); defaults to the first page., --page-cursor (string): Continuation token to return the next page. Use the next_cursor value from a previous page, for connectors whose declared pagination addresses pages by token (cursor, next_url, link_header).
- Reverse ETL write plans
  - create-feedback-template plan - Creates a feedback template. [intent=reverse_etl availability=implemented write=create_feedback_template]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Creates a feedback template. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --text (non-empty) (string): Lever text value.: maps_to=record.text, --instructions (non-empty) (string): Lever instructions value.: maps_to=record.instructions, --group (non-empty) (string): Lever group value.: maps_to=record.group, --field-id (non-empty) (string): Identifier for the first template field.: maps_to=record.fields.0.id, --field-type (non-empty) (string): Type for the first template field.: maps_to=record.fields.0.type, --field-text (non-empty) (string): Text label for the first template field.: maps_to=record.fields.0.text, --field-required (boolean): Whether the first template field is required.: maps_to=record.fields.0.required, --field-description (non-empty) (string): Description for the first template field.: maps_to=record.fields.0.description, --field-prompt (non-empty) (string): Prompt for the first template field.: maps_to=record.fields.0.prompt
  - create-form-template plan - Creates a profile form template. [intent=reverse_etl availability=implemented write=create_form_template]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Creates a profile form template. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --text (non-empty) (string): Lever text value.: maps_to=record.text, --instructions (non-empty) (string): Lever instructions value.: maps_to=record.instructions, --group (non-empty) (string): Lever group value.: maps_to=record.group, --secretbydefault (boolean): Lever secretByDefault value.: maps_to=record.secretByDefault, --field-id (non-empty) (string): Identifier for the first template field.: maps_to=record.fields.0.id, --field-type (non-empty) (string): Type for the first template field.: maps_to=record.fields.0.type, --field-text (non-empty) (string): Text label for the first template field.: maps_to=record.fields.0.text, --field-required (boolean): Whether the first template field is required.: maps_to=record.fields.0.required, --field-description (non-empty) (string): Description for the first template field.: maps_to=record.fields.0.description, --field-prompt (non-empty) (string): Prompt for the first template field.: maps_to=record.fields.0.prompt
  - deactivate-user plan - Deactivates a Lever user. [intent=reverse_etl availability=implemented write=deactivate_user]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Deactivates a Lever user. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --user (non-empty) (string): Lever user value.: maps_to=record.user
  - delete-feedback plan - Deletes a feedback form from an opportunity. [intent=reverse_etl availability=implemented write=delete_feedback]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Deletes a feedback form from an opportunity. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --opportunity (non-empty) (string): Lever opportunity value.: maps_to=record.opportunity, --feedback (non-empty) (string): Lever feedback value.: maps_to=record.feedback
  - delete-feedback-template plan - Deletes a feedback template. [intent=reverse_etl availability=implemented write=delete_feedback_template]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Deletes a feedback template. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --feedback-template (non-empty) (string): Lever feedback_template value.: maps_to=record.feedback_template
  - delete-form-template plan - Deletes a profile form template. [intent=reverse_etl availability=implemented write=delete_form_template]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Deletes a profile form template. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --form-template (non-empty) (string): Lever form_template value.: maps_to=record.form_template
  - delete-note plan - Deletes a note from an opportunity. [intent=reverse_etl availability=implemented write=delete_note]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Deletes a note from an opportunity. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --opportunity (non-empty) (string): Lever opportunity value.: maps_to=record.opportunity, --noteid (non-empty) (string): Lever noteId value.: maps_to=record.noteId
  - delete-requisition plan - Deletes a requisition. [intent=reverse_etl availability=implemented write=delete_requisition]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Deletes a requisition. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --requisition (non-empty) (string): Lever requisition value.: maps_to=record.requisition
  - delete-requisition-field plan - Deletes a requisition field. [intent=reverse_etl availability=implemented write=delete_requisition_field]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Deletes a requisition field. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --requisition-field (non-empty) (string): Lever requisition_field value.: maps_to=record.requisition_field
  ...
  - update-feedback plan - Updates a feedback form for an opportunity. [intent=reverse_etl availability=implemented write=update_feedback]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Updates a feedback form for an opportunity. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --opportunity (non-empty) (string): Lever opportunity value.: maps_to=record.opportunity, --feedback (non-empty) (string): Lever feedback value.: maps_to=record.feedback, --completedat (integer): Lever completedAt value.: maps_to=record.completedAt, --fieldvalue-id (non-empty) (string): Feedback field identifier for the first field value.: maps_to=record.fieldValues.0.id, --fieldvalue-value (non-empty) (string): Feedback value for the first field value.: maps_to=record.fieldValues.0.value
  - update-feedback-template plan - Updates a feedback template. [intent=reverse_etl availability=implemented write=update_feedback_template]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Updates a feedback template. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --feedback-template (non-empty) (string): Lever feedback_template value.: maps_to=record.feedback_template, --text (non-empty) (string): Lever text value.: maps_to=record.text, --instructions (non-empty) (string): Lever instructions value.: maps_to=record.instructions, --group (non-empty) (string): Lever group value.: maps_to=record.group, --field-id (non-empty) (string): Identifier for the first template field.: maps_to=record.fields.0.id, --field-type (non-empty) (string): Type for the first template field.: maps_to=record.fields.0.type, --field-text (non-empty) (string): Text label for the first template field.: maps_to=record.fields.0.text, --field-required (boolean): Whether the first template field is required.: maps_to=record.fields.0.required, --field-description (non-empty) (string): Description for the first template field.: maps_to=record.fields.0.description, --field-prompt (non-empty) (string): Prompt for the first template field.: maps_to=record.fields.0.prompt
  - update-form-template plan - Updates a profile form template. [intent=reverse_etl availability=implemented write=update_form_template]; approval: reverse ETL writes require plan, preview, explicit approval, then execute.; risk: Updates a profile form template. Reverse ETL writes require plan, preview, explicit approval, and execute.; flags: --form-template (non-empty) (string): Lever form_template value.: maps_to=record.form_template, --text (non-empty) (string): Lever text value.: maps_to=record.text, --instructions (non-empty) (string): Lever instructions value.: maps_to=record.instructions, --group (non-empty) (string): Lever group value.: maps_to=record.group, --secretbydefault (boolean): Lever secretByDefault value.: maps_to=record.secretByDefault, --field-id (non-empty) (string): Identifier for the first template field.: maps_to=record.fields.0.id, --field-type (non-empty) (string): Type for the first template field.: maps_to=record.fields.0.type, --field-text (non-empty) (string): Text label for the first template field.: maps_to=record.fields.0.text, --field-required (boolean): Whether the first template field is required.: maps_to=record.fields.0.required, --field-description (non-empty) (string): Description for the first template field.: maps_to=record.fields.0.description, --field-prompt (non-empty) (string): Prompt for the first template field.: maps_to=record.fields.0.prompt
- Help topics:
