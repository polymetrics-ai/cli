...
- Threads
  ...
  - threads get - Get a thread by id. [intent=direct_read availability=implemented]; risk: bounded Gmail JSON read; response is size-limited and secret-shaped fields are redacted; flags: --id (max 4096 bytes), --page, --page-cursor
...
- Drafts
  ...
  - drafts get - Get a draft by id. [intent=direct_read availability=implemented]; risk: bounded Gmail JSON read; response is size-limited and secret-shaped fields are redacted; flags: --id (max 4096 bytes), --page, --page-cursor
  - drafts create - Plan and execute the create draft reverse-ETL action. [intent=reverse_etl availability=implemented write=create_draft]; approval: requires plan, preview, approval, and execute; risk: creates a new unsent draft, visible to the mailbox owner; flags: --message (required)
  - drafts update - Plan and execute the update draft reverse-ETL action. [intent=reverse_etl availability=implemented write=update_draft]; approval: requires plan, preview, approval, and execute; risk: replaces the entire content of an existing draft; flags: --id (required), --message (required)
...
- Labels
  ...
  - labels get - Get a label by id. [intent=direct_read availability=implemented]; risk: bounded Gmail JSON read; response is size-limited and secret-shaped fields are redacted; flags: --id (max 4096 bytes), --page, --page-cursor
...
- Settings
  - settings filters get - Get a filter by id. [intent=direct_read availability=implemented]; risk: bounded Gmail JSON read; response is size-limited and secret-shaped fields are redacted; flags: --id (max 4096 bytes), --page, --page-cursor
  - settings send-as get - Get a send-as alias. [intent=direct_read availability=implemented]; risk: bounded Gmail JSON read; response is size-limited and secret-shaped fields are redacted; flags: --sendAsEmail (max 4096 bytes), --page, --page-cursor
  - settings delegates get - Get a delegate. [intent=direct_read availability=implemented]; risk: bounded Gmail JSON read; response is size-limited and secret-shaped fields are redacted; flags: --delegateEmail (max 4096 bytes), --page, --page-cursor
  - settings forwarding-addresses get - Get a forwarding address. [intent=direct_read availability=implemented]; risk: bounded Gmail JSON read; response is size-limited and secret-shaped fields are redacted; flags: --forwardingEmail (max 4096 bytes), --page, --page-cursor
  ...
  - settings send-as smime list - List S/MIME configs for a send-as alias. [intent=direct_read availability=implemented]; risk: bounded Gmail JSON read; response is size-limited and secret-shaped fields are redacted; flags: --sendAsEmail (max 4096 bytes), --page, --page-cursor
  - settings send-as smime get - Get an S/MIME config. [intent=direct_read availability=implemented]; risk: bounded Gmail JSON read; response is size-limited and secret-shaped fields are redacted; flags: --sendAsEmail (max 4096 bytes), --id (max 4096 bytes), --page, --page-cursor
  - settings filters create - Plan and execute the create filter reverse-ETL action. [intent=reverse_etl availability=implemented write=create_filter]; approval: requires plan, preview, approval, and execute; risk: creates a mail filter that automatically acts on future incoming messages matching its criteria (may auto-forward mail externally); flags: --criteria (required)
