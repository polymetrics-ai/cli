...
- Other Commands
  ...
  - operations get-customers - Declared etl: GET /customers. [intent=etl availability=partial]; notes: Blocked: locked source operation shipstation.provider.list-customers-7 has no declaration-owned executable etl route.
  ...
  - operations get-orders - Declared etl: GET /orders. [intent=etl availability=partial]; notes: Blocked: locked source operation shipstation.provider.list-orders-10 has no declaration-owned executable etl route.
  ...
  - operations get-products - Declared etl: GET /products. [intent=etl availability=partial]; notes: Blocked: locked source operation shipstation.provider.list-products-24 has no declaration-owned executable etl route.
  ...
  - operations get-shipments - Declared etl: GET /shipments. [intent=etl availability=partial]; notes: Blocked: locked source operation shipstation.provider.list-shipments-27 has no declaration-owned executable etl route.
