...
| Catalog | Track 547 bundle-backed connectors plus local runtime primitives. |
...
The repository tracks 547 bundle-backed connectors plus local runtime
primitives. Connector support is generated from JSON bundle metadata for auth,
...
- [ ] More connector bundle coverage and runtime-backed examples
- [ ] Homebrew tap
- [ ] Bundled MCP server
