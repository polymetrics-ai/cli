...
| Bounded protocol observation | Pending — redirect/retry/binary/error tests first | Pending | Pending | Assert count, bytes, truncation, and preserved child response. |
