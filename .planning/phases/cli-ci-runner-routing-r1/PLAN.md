...
1. Add a reusable selector routing job. It outputs the existing
...
3. Add a source-level routing contract test and run it from the conventions
   ...
   affected workflows.
4. Record a ready-to-use PR body plus the mandatory GitHub fork-approval and
   runner-group configuration. No server access, provisioning, deploy, push,
   PR, or merge is in scope.
