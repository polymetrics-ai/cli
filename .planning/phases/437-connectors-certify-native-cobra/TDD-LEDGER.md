...
| T5 | Delivery | Truthful final artifacts, coherent commits, active-branch push; no credentials/external commands/services/dependencies/PR/review | Verification artifact commit/push pending |
