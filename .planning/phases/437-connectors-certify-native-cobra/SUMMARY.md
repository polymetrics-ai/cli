...
Focused and effect-recorder tests pass, including repeated ×10 and race (`1.726s` CLI, `2.535s` certify). Full CLI passed `440.910s`; full certify passed `346.271s`. Remaining work is local sample/no-op/help smoke plus gofmt/vet/full test/build/`make verify`/connectorgen and final artifacts. Verification remains fixture/synthetic-reference/temp-only; no credentials, live services, external writes, dependencies, PR, or review.
