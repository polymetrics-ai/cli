...
Build validated cli_surface.json covering streams, GET direct reads, typed write commands, and blocked operation metadata without exposing raw API writes.
