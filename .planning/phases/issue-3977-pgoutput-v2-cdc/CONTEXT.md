...
5. Stage material is rooted below the caller's project directory, with source-derived safe names and explicit finite limits. A missing project directory is refused rather than silently falling back to an ephemeral spool.
