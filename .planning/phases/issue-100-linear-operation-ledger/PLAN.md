# Plan — #100 Linear operation ledger
...
Inventory Linear GraphQL root operations from a read-only public SDK/schema source, classify each operation into safe direct-read/ETL/reverse-ETL/admin/destructive/sensitive buckets, and keep non-executable operations blocked by default.
