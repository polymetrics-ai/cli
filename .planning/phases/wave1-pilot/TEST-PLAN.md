...
| zendesk-support | ✓ all legacy streams | ✓ cursor page[after]/meta.after_cursor 2-page; meta.has_more=false stop | ✓ start_date-raised | ✓ BOTH modes: Basic `<email>/token` AND OAuth Bearer (when-gated candidates) | — | ✓ |
