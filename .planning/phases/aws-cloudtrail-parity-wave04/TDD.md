...
- Scope correction reverted the shared interface forwarding/validator/cache edits and reclassified the exposed CloudTrail surface to 19 implemented streams plus 41 blocked/planned direct/write operations.
- Focused green tests:
