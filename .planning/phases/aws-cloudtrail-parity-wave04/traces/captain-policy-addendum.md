...
- Blocked/planned breakdown: 10 provider query/direct-read actions and 31 write/admin actions require shared promoted-native command-surface, manifest, write-validation, dry-run, and operation-direct-read forwarding that was reverted from this connector-local branch.
