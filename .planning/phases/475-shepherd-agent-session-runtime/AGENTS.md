...
The issue worker owns every write in Cycle 11. One read-only explorer maps the installed, explicit
...
advisory; the issue worker retains the complete mutating and verification critical path.
