# Google Calendar parity resume test plan

1. Reproduce the required-body-flag validator failures before editing `cli_surface.json`.
2. Validate the corrected bundle and ensure all implemented commands pass real runtime preflight.
