# Plan: GitLab Operation Ledger (#86)
...
- Lane prompt: `scripts/gsd prompt execute-phase issue-86-gitlab-operation-ledger --tdd`
...
Inventory the official GitLab OpenAPI operations into api_surface operation-ledger classifications.

## Scope

internal/connectors/defs/gitlab/api_surface.json, generated operation evidence
