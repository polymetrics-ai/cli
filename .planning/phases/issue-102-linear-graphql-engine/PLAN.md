# Plan — #102 Linear GraphQL engine
...
Wire Linear streams and writes to existing fixed-document GraphQL body support; add regression tests for Linear GraphQL request bodies and pagination.
