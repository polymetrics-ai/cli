...
| Green | Added generated fixed Linear mutations for all SDK mutation rows plus engine support for `source` GraphQL variables, record-scoped variables, omitted absent optional variables, and default config materialization for writes. | done |
