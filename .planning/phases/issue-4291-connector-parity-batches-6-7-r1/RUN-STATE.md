...
- Current green slice: repaired the Gorgias operation-ledger metadata that made CI `Verify` fail; regenerated the two stale website data projections. No credentials or live provider operations were used.
