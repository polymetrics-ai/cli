...
| `dimensions[]` body | `searchanalytics/query#request-body` | T3 marks Optional; T1-equivalent enum schema | High | Provider-optional. | Each stream provides one fixed documented dimension. |
