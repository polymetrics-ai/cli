...
Fresh #3897 child for the #4066-owned canonical-equivalent unique-table
defect. The strict real Parquet/DuckDB RED and minimum GREEN are complete on
the immutable #4060 descendant: connection-scoped reads stay isolated,
unrelated generic SQL remains executable, and omitted flows retain the typed
