...
- Green: `go test -timeout 20m ./cmd/connectorgen ./internal/connectors/certify ./internal/cli` — pass after rebasing to `c9791db4d`; the schema-v2 direct-read proof path and declaration-owned stage selector are exercised without connector-specific Go.
