...
- Refactor: In progress. The shared selector replaced both Arrow-only special cases and now governs generic, run-scoped overwrite, serial Arrow, and pipelined Arrow extraction. Formatting and focused tests are green; broad gates and review remain.
