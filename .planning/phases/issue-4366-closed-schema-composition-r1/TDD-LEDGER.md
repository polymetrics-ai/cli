...
| Provider regressions | Batch 1 fixture covers Bitbucket, CircleCI, GitLab, Jira, and Vercel records. | Add representative retained source cases where their pinned artifacts are available without overlapping active materialization lanes. | No connector-special case in common code. | pending |
