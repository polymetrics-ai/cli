# Generated by scripts/gsd prompt quick --full Implement connector-local Asana official API parity for parent issue #380 with complete operation ledger, typed destructive confirmation policy, no live provider calls, and no shared runtime edits
# Repo: /Users/karthiksivadas/.treehouse/cli-83d592/18/cli
# Official GSD: github.com/open-gsd/gsd-core@20297a8ff941378b8615a5d3e8629e52c10a0f9d
# Runtime adapter: pi-project-local

# Execute official GSD command in Pi: /gsd-quick --full Implement connector-local Asana official API parity for parent issue #380 with complete operation ledger, typed destructive confirmation policy, no live provider calls, and no shared runtime edits
...
- Command: `/gsd-quick`
- Args: `--full Implement connector-local Asana official API parity for parent issue #380 with complete operation ledger, typed destructive confirmation policy, no live provider calls, and no shared runtime edits`
...
- `/Users/karthiksivadas/.treehouse/cli-83d592/18/cli/.gsd/commands.json`
- `/Users/karthiksivadas/.treehouse/cli-83d592/18/cli/.gsd/upstream.lock.json`
- `/Users/karthiksivadas/.treehouse/cli-83d592/18/cli/.gsd/official-docs/COMMANDS.md`
