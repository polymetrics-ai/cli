...
- CI headroom inference: applying the measured 14.5% local reduction to the documented 1180.982s integration result yields approximately 1010s, 190s (15.9%) below the unchanged 1200s ceiling. Hosted CI has colder cgo linking, so the direct removal of 17 duplicate links is expected to be at least as effective; the PR records this as an inference pending its hosted Verify measurement.
