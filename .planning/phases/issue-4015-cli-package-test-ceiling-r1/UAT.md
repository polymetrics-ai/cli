...
| The normal verification command no longer collides with the ceiling locally | `make verify` runs `go test -timeout 20m ./...` and reports `internal/cli` passing in 685.504s. | pass |
