...
## 2026-09-06 — Firstmate094 adopts complete091 audited ledger and proof design

Frozen reviewed code: 8aadc1cef19ea1a0b329ec898feb07e68e96913e, tree b40b84816189eb1a795d48556ec0e25547d76362; original review base 36e4d980de0d51d92fe74a68306845643596a6cb. Firstmate094 adopts the complete audit below. Both low-impact proof blockers remain mandatory; the historical-reference warning receives the specified evidence-only clarification. All six original dispositions, ten lenses and sibling obligations are retained. This audited evidence checkpoint precedes all corrective test edits; it is not CP11 acceptance.

Commit b8c36b6f preserved the complete089 aggregation only: the attempted091 append had a Python bytes-literal encoding error before any write, while the subsequent commit command still executed. Its title overstates its contents. This additive checkpoint supplies the exact091 audited record; no prior commit is rewritten and no test edits preceded it.

Report SHA-256: f0dcb5abe32b4139cf56b5d3893b4fc83917d8407b798d997b2a7f26f051a7a3

<!-- BEGIN IMMUTABLE COMPLETE091 AUDIT -->
---
phase: batch-r1-vnext-cutover
checkpoint: CP11
depth: deep
status: issues_found
reviewed: 2026-09-06T11:02:34Z
files_reviewed: 15
files_reviewed_list:
  - cmd/connectorgen/vnext_publication.go
  - cmd/connectorgen/vnext_publication_dir.go
...
findings:
  ...
  info: 0
  total: 3
severity_note: critical counts mandatory acceptance blockers, not critical production impact; both proof blockers have low demonstrated direct impact
review_base: 36e4d980de0d51d92fe74a68306845643596a6cb
review_candidate: 8aadc1cef19ea1a0b329ec898feb07e68e96913e
review_tree: b40b84816189eb1a795d48556ec0e25547d76362
---

# CP11 complete-ledger proof audit and diagnosis 091

## Task delivery header

- Issue: Refs #4427 / parent #4325; existing PR #4294.
- Base branch: `main`, attributed to the existing delivery record and design079; this task opens no PR and makes no API or ref changes.
- Merges into: `main`; no merge or publication authority in this task.
- Delivery: This private complete-ledger verdict, bounded proof design and SHA-256 returned to the canonical Firstmate owner.
- Working branch: `fm/cli-top100-declaration-batch-r1`.
- Task: Independently adjudicate the complete frozen ledger, diagnose recurrence of 7481-04, specify the smallest complete test/evidence correction, and assess validation dependencies without editing source/tests/dependencies.
- Verification: Immutable Git/source and contract reads; semantic caller/assertion tracing; reference and receipt hashes; source custody checks; terminal report hash. Static review is not a new execution result.

| Acceptance criterion | Evidence | Observable assertion / limit |
| --- | --- | --- |
| Correct candidate and read-only custody | live | Read local Git identities and changed paths; compare source/test/dependency bytes to frozen commit. |
| Complete ledger and sibling adjudication | live | Trace actual immutable producer/caller/assertion source against original073 and adopted079 contracts. |
| Implementation-ready correction and falsification | live | Name independent inputs, acquisition cuts, deltas, observations and exact caller oracles; proposed tests are not executed results. |
| Validation impact and historical integrity | live | Verify existing receipt/source bindings and immutable current policies while preserving unresolved historical digest claims. |

## Verdict and scope

**Keep CP11 unaccepted. Uphold 089-01 and 089-02 as two residual proof obligations under original 7481-04; retain 089-03 as an evidence warning with the current-policy clarification below. No additional material finding was established. No finding is withdrawn.** The two blockers have low demonstrated direct impact. Neither establishes that current production publishes a wrong generation or deletes an unowned directory. The `critical: 2` count is the review pipeline's acceptance tier, not two critical production vulnerabilities.

This is a complete-ledger audit and bounded proof-design diagnosis, not a replacement execution receipt or authorization to edit. I read all of 073, 079 and 089, challenged the six original dispositions against their relevant immutable implementation/proofs, and independently followed the complete 089 caller table. I retain 089's original-range review coverage and limits explicitly; I do not describe this focused ledger audit as a second fresh full-file review of every one of its 47 nonplanning paths.

Verified local identity: branch `fm/cli-top100-declaration-batch-r1`, HEAD `8aadc1cef19ea1a0b329ec898feb07e68e96913e`, tree `b40b84816189eb1a795d48556ec0e25547d76362`. `git merge-base --is-ancestor 36e4d980de0d51d92fe74a68306845643596a6cb HEAD` exited 0. The original range contains 115 paths: 47 nonplanning and 68 planning/evidence paths. At inspection the sole tracked working-tree modification was `REVIEW-CONVERGENCE.md`, whose bytes matched the dispatched hash. No reviewed source, test, dependency, ref, index, original artifact or protected `.cache/` was changed by this audit.

Project AGENTS, required-skill routing, task-header, GSD adapter and CLI-parity guidance were read. Applied skills: the pinned `firstmate-exhaustive-review`, project `caveman` and `connector-lane-build-order`, and applicable Go how-to, testing, error handling, safety, security, lint, CLI and concurrency guidance. `scripts/gsd sources code-review` resolved successfully; installed review guidance was inspected. No `.codegraph/` exists, so no index was created. There is no `.codexignore`. The existing Atlas entry `authoring.source-lock-vnext.v1` owns the publication foundation and proof seams; this proposal reuses its test seams and adds no shared runtime foundation. Astra/xhigh routing, final-only return and approved 087/088 scheduling supersede historical routing/push wording, without waiving proof, final gates or original-range independent review.

## Authority and exact-byte reconciliation

Private report names below are relative to `/Users/karthiksivadas/pm-cli-agent-workspace/data/cli-batch1-pi-takeover/`; project evidence names are relative to `.planning/phases/batch-r1-vnext-cutover/` in the worktree above.

| Authority/evidence | Independently verified SHA-256 / reconciliation |
| --- | --- |
| Complete 089 report | `c8af5a801a22a8e109e9b12f1227339f6ec30389fe9922c23b66094c191ff642`; exact complete bytes occur in current convergence record. |
| Original complete 073 audit | `bc109e85fdde9d1958b2cde7874a3f7b30b8e5d06b1b0c2764088fb34fa3e0a0`; exact complete bytes occur in convergence at evidence commit `053853368a1514eaadf0b2411ab8740959559797`. |
| Adopted design079 | `35f8926266fdae784e88d429eeea0b27adcd114a1550ca47cd7dece3f592a417`. Its independent pending-graph/expected-state contract governs this correction. |
| Current convergence | `b13a8585ba91b9120500a064d78e8dfdc9625352187065c6537ba3fdda787375`. |
| CP11-ACCEPTANCE.json | `71529be0e953cf8ab5240708118cccfc2c8ca05663904818d1d94bdebc43f5f9`. |
| Final validation packet089 | `cc9d7bff36b52537e9bad321755b9e5b07e86a09725cd2a18c5166e76c466d70`. |
| Immutable current ENGINEERING policy | `8827280eb1df065870975e5c0f46225b2b75c5a6ea8cf8c0a041f5c1ad78d690`. |
| Immutable current QUALITY plan | `6f43608b411136c859208e8d8cbc115b7914d3f4356a4ee0fb3f877e1a3d3274`. |
| Current policy VERSION.json | `f9989a8a77e381052b90932c8be71d7f50247f176b521649f84bc375b1b21091`; explicitly says these are newly preserved 087/088 copies, not recovered 080 versions. |

Current policies are under `/Users/karthiksivadas/pm-cli-agent-workspace/data/batch-one-execution/policy-versions/2026-09-06-087-088/`. The approved evidence requirements were also read in full. Original 073's 7481-04 and 079's expected-state section already require independently expected new controls, actual root witnesses, stable history and allowed transitions. This report applies that contract; it does not introduce arbitrary-tamper recovery or a stronger product specification.

Mechanical reconciliation: all 119 obligation IDs are unique; all 231 current proof-group references resolve to 28 groups; all 36 distinct test symbols and all 606 assertion lines/texts match their source hashes and declarations. All 36 tests occur as passing top-level tests in both completed candidate runs. All seven historical tracked-source references match their declared historical commits. Traversal of all 18 path/SHA references finds exactly the two historical mutable-policy mismatches described in 089-03. These counts establish referential integrity, not the semantic adequacy of an oracle. The manifest's `closed: false` and earlier pending-execution wording remain immutable chronology; a companion must reconcile final receipts and this verdict instead of silently rewriting the original snapshot.

## Complete merged-ledger disposition

Source abbreviations in the following tables resolve to absolute files below `/Users/karthiksivadas/.treehouse/cli-6bae67/2/cli/cmd/connectorgen/`: **P** `vnext_publication.go`; **D** `vnext_publication_dir.go`; **R** `vnext_publication_repair.go`; **E** `vnext_publication_expected_test.go`; **DM** `vnext_publication_durable_matrix_test.go`; **PT** `vnext_publication_test.go`; **G2** `vnext_publication_group2_original_test.go`; **RR** `vnext_publication_record_result_test.go`; **PF** `vnext_publication_phase_frontier_test.go`; **RE** `vnext_publication_resource_error_test.go`. Other test filenames are written out. Line numbers refer to frozen 8aadc1ce.

| Original finding / current rows | Independent disposition and concrete challenge |
| --- | --- |
| 7481-01, 35 rows; original production Medium | Repair remains supported. D:199 returns the actual opened resource plus parent-completion result; R:480 common writer owns identity-known incomplete-record disposal and one Close, preserves complete bound records on completion errors, and refuses unknown/replaced authority. R:1346 preparation adopts retained-complete state before error handling; R:1518 registers written phase state before returning completion error. Traced all seven PF phase callers and their actual created record/phase cuts, not just a common-writer unit test. `record-frontiers`, `record-results`, `prepared-frontiers`, `control-states`, `phase-callers` have real completion/refusal, pre-restoration state, nonmutating Check and fresh-retry evidence. F03A's remaining desired-anchor proof is retained under 04, not misreported as failure of this production repair. |
| 7481-02, 14 rows; original production Low | Repair remains supported. P:991 distinguishes primary exclusive collision from parent/raw/root completion and bound-cleanup outcome before bounded retry; a compound EEXIST is not silently successful collision handling. Actual matching-A nonempty retention has its deliberately narrower retry meaning. `allocator` and eight `allocation-consumers` trace actual producers through temp, direct writer, CURRENT/JOURNAL write, stage, repair/capture and public consumption; causes and actual owned effects are asserted. No new retry/absence misclassification was established. |
| 7481-03, 11 rows; original proof Low | Required failed-allocation witnesses are supported. `vnext_publication_allocation_witness_test.go:1–202` exercises the five actual callers with empty/nonempty DIRECTORY B, captures actual opened A and actor-created B, keeps displaced A in its compared tree, verifies exact tree/causes/resource Close, nonmutating Check, fixture restoration and bounded fresh retry. A real O_EXCL blocker supplies temporary-allocation failure. The separate older successful-allocation/later-cleanup cases are complementary, not substitutes. No universal arbitrary replacement-recovery guarantee follows. |
| 7481-04, 30 rows; original proof Low | **Open through BLOCKER 089-01 and BLOCKER 089-02 below.** All eleven cut groups and the shared oracle/F03A consumers were inspected. Stable-history, descriptor-safe comparison, actual lease A/B identity and several static-control rows are real improvements; fixture intent and external early-stage A still escape the relevant assertions. |
| 7481-05, 6 rows; original claim Low | Corrected claim remains supported. RE:193 names Publish **initial recovery**. Required nested owned-stage Recover and stale-generation Prune execute real recursion, repeated no-GC resource accounting and actual child/quarantine Close ownership (D:471). Post-Stat performs actual Stat then injected completion, proving retained nested bytes/outer root and Close, not a naturally failed Stat or pre-operation nested-child identity. Atlas catalog constraint at 287 preserves these limits. No additional nested final-Publish row is required. Actual final-prune lease proof remains a distinct 04 obligation. |
| 7481-06, 23 rows; original proof Low | Stipulated compound proof is supported by `old-compounds`, `parent-raw`, `readDir-owner`, `opened-control`, `failed-link`, `capture`, `stage` and overlapping record/allocation groups. Read actual opened-control identity/stat/read plus Close, failed predecessor link plus Close, primary capture plus actual Sync/Close, actual staged writable Sync/Close/cleanup, and per-resource one-Close assertions. Original058's narrow writable completion class is met; adding every staged Write/error combination or a Cartesian error matrix is not required. No additional production error-loss defect was established in this ledger audit. |

Preserve the previously accepted scope of F04R safe observation; F08R actual nonblocking lock attempt plus acknowledged signal/wait; B01 no-replace A/B/C preservation; B02 strict bootstrap; R3 FIFO refusal, bounded live descriptors, returned validated A, independent directory-lifetime lock and lease identity; F01's six actual capture-open witnesses; and F02's immediate recursive-child Close repair. No-GC descriptor bounds do not bound retained disk history. Historical F07 remains RED 12.383s → routing edit → GREEN 15.417s; there is no recovered full uncommitted RED tree and no relabeling of commit729. Original 073's historical provenance, CP29 debt and review limitations are retained, not inferred away from absence of new edits.

## Narrative findings and implementation-ready correction

### CP11-089-01 — BLOCKER: fixture intent is replaced by an observation of the produced state

**Impact:** mandatory acceptance proof defect, low demonstrated direct impact; no demonstrated production wrong-selection bug. **Files:** E:251–264, E:285–321, G2:392–443 and the full caller map below. **Fix:** make fixture-derived intent and validated new-object acquisition explicit inputs to these actual caller oracles.

The data-flow mistake has two forms. First, real callers publish a fixture, read the produced CURRENT or JOURNAL.New, and pass that same value back as the expected result. `CaptureExpectedCut` preserves prior stable members, checks new phase labels against the new prepared record's own Intended, then snapshots the produced connector tree. A coherent wrong generation, journal and terminal graph can therefore supply both sides of the check. Second, F03A captures anchors before record writing but asks only for prior/intended presence booleans. Its later helper obtains the supposedly expected identities from `state.record.Prior/Intended`, then checks that the anchors match that record. Capturing an actual anchor early prevents later replacement but does not establish that its bytes equal the requested write.

The helper's negative tests correctly reject a wrong root/inode, changed bytes, missing history and a wrong phase when given a good expectation. They do not certify how production-facing test callers construct that expectation. The repair repaired identity comparison and history coverage, while a produced value remained the semantic source of truth. This is why more rows and assertions looked complete without closing the original invariant. It is a specific dependency error, not a model attribution or a claim about time spent.

Use a small test-only value representation in E, consumed by the existing fixtures. It needs only: (a) deep-copied fixture artifact files and independently computed desired generation/integrity/pointer/control bytes; (b) prior full-tree/control/history witnesses captured before the tested transition, after validating the fixture setup; (c) a short ordered slice of desired control transitions, each naming target, prior/present payload, intended/present payload, selected payload and allowed phase prefix/outcome; (d) separately acquired actual identities for newly created transaction, anchor, capture and record objects. Keep desired values immutable. Actual-identity fields begin unbound and can be filled only after an independently expected payload/shape check at the specified cut. No production abstraction, on-disk format, generic state-machine framework or dependency is needed.

Derive the desired generation with the existing pure `vNextPublicationGenerationID` (P:1961) from cloned declared fixture files, then desired integrity bytes/pointer with pure `vNextPublicationIntegrityForFiles` (P:1973) **before** Publish/Recover/target write. Serialize the expected CURRENT and prepared/committed JOURNAL from those fixture values with the same declared JSON/newline format (P:852–882). Reusing a pure deterministic transform of independent fixture input is sufficient here; independently reimplementing hashing is not this contract. Do not use the returned pointer, observed JOURNAL or prepared.Intended to derive desired values. Validate the old fixture publication against its own independently derived input before adopting its existing inode/history as prior state.

| Object/input | Actual acquisition cut and what independently validates the capture |
| --- | --- |
| Existing controls/history/roots | Capture before the tested operation or its declared setup transition. Preserve complete relative membership, type, identity and bytes, including stable marker/transactions/anchors/phases. Freeze the snapshot; do not delete a prior member from expected state because production deleted it. |
| New generation/stage | Use the existing staged-directory/before-stage-rename cut after the files exist and before selection. Discover the unique newly allocated fixture-owned stage relative to retained generations; compare its artifact membership/bytes, desired generation and integrity bytes, empty regular lease and typed marker to the precomputed fixture intent. The marker's stage name is the actual allocated name, while connector/generation come from independent intent. Only then capture actual directory/member identities. Rebase that witness to the independently desired final generation on the permitted rename. Lease A displacement/B installation is an explicit fixture delta with separately captured actual A/B, not permission to resnapshot arbitrary new members. |
| New repair transaction and anchors | Compose the existing `BeforeControlRepairRecord` hook (R:1472) with current fault hooks. At that cut anchors already exist and have synced, but prepared.json has not been written. From the prior inventory plus the expected next target transition, locate the one new transaction through descriptor-safe observation; require its bounded allowed members. Prior anchor must bind the immutable prior control/selected predecessor witness. Intended anchor bytes must equal the requested fixture payload before its actual regular-file identity is adopted. An absent intended control means no replacement anchor. A base transition must retain the preexisting public inode in both anchors with the same expected bytes. |
| Prepared/phase/capture records created later | Observe actual descriptor identity at the existing record Write/Sync hooks or the relevant completed cut, after checking record fields against the expected target, acquired anchor identities, prior predecessor and explicit phase plan. Capture-directory names/identities are runtime-created facts: acquire after actual creation, verify directory/allowed emptiness and attempt, then bind phase references to those facts. Digest/previous-record references derive from already validated expected records. Reject unknown extra transactions/phases/members, wrong predecessor, wrong candidate/selection/outcome and missing required transitions. Do not use the prepared record's Intended as the independent expectation. |
| Final observed cut | Construct expected membership from prior witnesses plus these checked acquisitions and explicit permitted renames/control transitions. `CaptureExpectedCut` must accept the fixture/transition expectation and validate the actual new objects before returning a preservation snapshot. Comparing that exact snapshot after refusal and after nonmutating Check then proves stability of an independently validated cut. |

For ordinary uncontended successor transitions in these cleanup fixtures, the allowed phases are `capture_intent → captured → selected → terminal`, attempt one and outcome committed, with captured candidate tied to the expected prior occupant/absence and selected tied to the validated intended anchor/absence. A bootstrap base has its existing single terminal phase; F03A interruption has prepared plus **zero phases**. Expected target/transition count comes from the caller fixture, not the number of newly discovered prepared records. Preserve production graph validation as an additional consistency check. Publication may replace CURRENT with a new inode, including writing old pointer bytes during rollback: require the actual validated new anchor identity and desired bytes, never preservation of the previous CURRENT inode where replacement is legitimate.

#### Complete affected and unaffected sibling map

Notation: **P** in this table is the independently validated old pointer; **N** is the new fixture-derived pointer; **JP** is `{Old:P, New:N, State:prepared}` and **JC** the corresponding committed journal; **∅** is logical absence. The code's exact JSON encoding is part of the expected payload. Listed transitions are deltas from the fixture's captured stable starting point. Each present-to-present write may legitimately acquire a new inode. B variants retain their existing empty/nonempty coverage without adding a Cartesian matrix.

| Actual caller / frozen lines | Expected input ownership and precise correction |
| --- | --- |
| DM:378–412, empty-B prepared/new-selected Recover | Derive N from the fixture at 403 before interrupted Publish. Expected setup transitions: JOURNAL ∅→JP, CURRENT P→N; interruption at AfterCommitSync precedes installation of JC. CURRENT at 408 is an observation, not expected N. At the cleanup refusal expect CURRENT N/JOURNAL JP, exact old/new generation witnesses and actual A/B. After restoring A, fresh Recover clears JP and leaves N. |
| DM:417–451, empty-B committed/new-selected Recover | Precompute N before 442. Setup adds JOURNAL JP→JC after the preceding two transitions. Refusal expects N/JC; restored fresh Recover clears JC and keeps N. Remove the current-at-447-to-want-at-451 dependency. |
| DM:456–522, empty-B successful Publish final prune | Replace nil `wantCurrent` at 466 with the fixture's N and desired JP/JC. The shared helper at 473 must receive intent before invoking Publish; eliminate the skipped CURRENT check at 515. Expect the three completed setup transitions above at the real final-prune lease cut. |
| DM:536–626, nonempty-B committed/new-selected Recover | Derive N from `newSet` at 550 before Publish. Replace observed `newPointer` at 568 as expectation in refusal and post-recovery checks at 612/623. Same N/JC transition schedule and validated generation/artifact binding as the empty row. |
| DM:629–699, nonempty-B successful Publish final prune | `newSet` at 639 owns expected N; `newPointer` at 679 is final observation. Validate three transitions before accepting the captured cut at 664. Require N/JC at refusal and N/∅ after restored Recover, preserving actual A/B and prior history. |
| PT:2741–2835, nonempty-B prepared/new-selected Recover | Derive N before fixture Publish at 2766. Replace `selectedNew` read at 2771 as expected CURRENT/JOURNAL.New at 2821. Use prepared setup/refusal/recovery schedule above. |
| DM:702–800, fresh rejected-new Recover, both B shapes | Derive N and rejected root from `newSet` at 718, not interrupted JOURNAL.New at 732–738. AfterStageRename setup has only JOURNAL ∅→JP; CURRENT remains P. Refused Recover has P/JP and the independently intended rejected generation. After restoring A, recovery removes that rejected generation and clears JP, retaining P. |
| DM:803–892, immediate rollback, both B shapes | Keep the independently derived rejected generation path at 829. Also compute its integrity/pointer from `broken` fixture files before Publish; bind JOURNAL.New to this N instead of the self-value at 871–878. Expected pre-refusal deltas: JOURNAL ∅→JP, CURRENT P→N, CURRENT N→P as a legitimate replacement write. No committed journal is installed. After restored fresh recovery, JP clears and the rejected generation is removed. This is the narrower journal-value omission, not absence of the existing root witness. |
| PT:101–275, held-reader **Publish** | After fixture B and the real held A/lease witnesses are established, derive C from the fixture supplied at 198. Expected delta: JOURNAL ∅→prepared(B,C), CURRENT B→C, JOURNAL prepared→committed→∅. Validate each expected transition before `recordControls` at 124–128 adopts its new identity; do not replace expected values with every observed transition. Preserve held A and its lifetime lock; intermediate unheld B may be legitimately pruned. |
| PT:101–275, held-reader **Recover** | Before interrupted Publish at 223 derive expected B; setup JOURNAL ∅→prepared(A,B), CURRENT A→B. During Recover, held A defers pruning and JOURNAL clears; B remains selected. Replace the observed-control expectation at 228–230 and blind `recordControls` adoption with this declared plan. Actual held A and independent lease witnesses remain valid and must stay. |
| PT:101–275, held-reader pure **Prune** | No publication/control transition is intended. Keep exact pre-operation CURRENT/JOURNAL/history plus actual held root/lease A/B comparisons. Migrate only to pass an empty allowed-transition list if the helper is shared; do not invent a missing desired-new-generation obligation. |
| PT:2647–2740, Prune / no-JOURNAL Recover / initial-recovery Publish / Open cleanup | These four rows already expect preexisting CURRENT and no new control transition before the refusal. Preserve this valid narrower oracle. When migrating `CaptureExpectedCut` at 2718, give it the validated prior tree and empty delta list; do not allow new transactions by observing them. |
| PT:2046–2130 early and PT:2375–2455 late owned-stage Recover | No new CURRENT/JOURNAL transaction is intended at these refusal cuts. Keep static control/history expectations; early displaced A needs the distinct fix below. Late `.late-original` stays inside the compared connector tree and is not the omitted-universe defect. |
| PT:831–879 Check; PT:881–908 pending-JOURNAL Check | Keep their exact pre-operation tree/raw-state comparisons and refusal/nonmutation meaning. No publication delta is allowed and no generation lease requirement is added to Check. |

#### Every F03A pending-prepared helper consumer

Change `vNextPublicationAssertPendingPreparedGraphForTest` at G2:392 to accept the desired target states and acquired anchor/transaction witnesses, replacing presence booleans as the only expected semantic input. Keep full `knownTransactions` preservation at G2:394 and before-record comparison at 239. Require exactly the expected new prepared transaction, its correct target/predecessor/prior/intended payload-bound identities and zero phases, alongside unchanged public prior state. Decode production graph for consistency but compare it to the independent expected record/anchors. Do not merely require that some new transaction for the target exists.

| Exact consumer | Independently specified target write / allowed state |
| --- | --- |
| G2:242 in `TestCP11F03ARepairPreparationFrontierMatrix` | All seven existing fault frontiers across JOURNAL absent→prepared `{New:old}`, CURRENT present→same old pointer payload, and JOURNAL prepared→absent. Compute the desired payload before `target.write`; capture prior control after `target.prepare` but before the tested write. In retained-complete cases expect validated anchors + prepared, zero phases. In before-record/short-write cases keep existing bound cleanup/no-new-prepared expectation and immutable prior history. |
| G2:323 in `TestCP11F03ARepairBasePresentPresentAuthorityRecovers` | Both CURRENT and JOURNAL bootstrap targets. Before `createBaseControlAuthorityLocked`, capture the actual existing public control after the fixture-only graph removal and validate bytes against old fixture pointer/journal. Prior and intended anchors must bind that **same** preexisting inode/payload, predecessor absent, zero phases at the interruption. After fresh recovery retain existing valid bootstrap/Check/retry behavior. |
| RR:211 in `TestCP11OwnershipRemainingControlStates` | CURRENT absent→pointer; CURRENT pointer→absent; JOURNAL prepared→committed `{New:pointer}`; JOURNAL absent→absent. The last is still the existing explicit durable transition, not permission to omit a prepared record. Precompute desired bytes and capture prior at the pre-write cut. Require the existing one prepared Sync-completion fault, phase-free state, exact old controls/history and fresh recovery. This third call site is an explicit clarification of 089's F03A helper/caller scope, not a new finding. |

### CP11-089-02 — BLOCKER: displaced early-stage A is outside the observed tree

**Impact:** mandatory preservation-proof defect, low demonstrated direct impact; no demonstrated production deletion. **File:** PT:2046, mutation/capture at 2072–2074, incomplete A assertion at 2092–2100, helper at 2209–2215. **Fix:** retain and compare a separate bounded external-A witness before names are restored.

`vNextReplaceOwnedStageForTest` moves actual A to a different `t.TempDir`. The expected tree from `root/acme` cannot include it. Before restoration, the row checks only that A's sentinel is readable and nonempty; it does not compare A's original directory/member identities, types, membership, marker bytes or exact sentinel bytes. Recover refusal plus later restoration/retry cannot supply an observation that never happened at the refused cut. In contrast, late-stage PT:3105 moves A to `.late-original` **inside** the compared tree. Actual failed-allocation DIRECTORY A/B and regular lease-file A/B tests retain their own distinct witness scopes; this finding does not invalidate them.

Choose the following concrete bounded strategy rather than changing where production encounters the fixture. Immediately after `vNextWriteOwnedStageForTest` (PT:2187) has created the known stage and **before** `Recover` can reach its removal hook, validate the declared marker fields and sentinel `original`, then capture `wantStageA := ObserveExpectedTree(stagePath)`, including `.` and every member. Keep its cloned bytes/identities immutable. At the existing replacement hook, rename A externally and create B exactly as today; keep the existing actual-B and connector/authority cut comparison. After Recover refuses, compare **both** the connector tree and `movedPath` against their respective expectations. Run fresh Check, require its existing refusal, and compare both again **before** removing B or renaming A back. Then perform the existing bounded fixture restoration, fresh Recover, Publish and Check.

The existing observer's retained no-follow directory traversal and regular opened-fd identity/read pairing (E:67–123) are suitable acquisition primitives: each object identity and bytes come from that same opened object; descriptor-relative child access/type checks remain. Observe only the known fixture-owned moved path, not arbitrary external directories, and never use its post-move identity as the expected identity. Relative keys allow one pre-move witness to compare at the moved name. Use a small nonfatal combined verdict helper so the real early-stage row and its negative controls share the **same** two-root oracle. This is a test-only second witness, not an expansion of the runtime deletion or recovery contract.

### CP11-089-03 — WARNING: historical080 hashes remain unresolved; current authority is now immutable

**File:** `/Users/karthiksivadas/.treehouse/cli-6bae67/2/cli/.planning/phases/batch-r1-vnext-cutover/CP11-ACCEPTANCE.json:55–64`. The two referenced mutable policy files have evolved. Their original QUALITY hash `48def9ce4bb18dc7c6f288d32c4bb09d9929bceadf01cf23e44c8befaa8790af` and ENGINEERING hash `f67d49f98cc222305f7d62afd73ace84478b6ebabaab47a03d4e80eaa899eb6c` do not resolve to those current bytes. The newly supplied immutable 087/088 directory and VERSION.json resolve current governing policy; they do **not** recover historical080 bytes. No conflicting current authority was established.

**Evidence-only correction:** append a companion/current projection stating: (1) preserve the original080 path/hash claims verbatim as unresolved historical digest references, (2) bind governing087/088 policy to the immutable paths/hashes above, (3) note that VERSION.json documents the provenance distinction, and (4) link any subsequently recovered actual080 bytes separately if recovery ever succeeds. Preserve original reports, manifests, approvals and chronology. No production change, policy rollback or fabricated hash recovery is needed. The warning's reproducibility limitation remains historical; it is not a blocker on knowing the currently governing instructions.

## Meaningful falsification and RED → repair → GREEN plan

These are proposed tests, **not executed probes or historical production REDs**. Static source dependencies settle both findings without modifying the frozen candidate. The next owner should first record the approved test/evidence scope and TDD ledger, then add the bounded counterexamples at the actual caller oracle. If extracting a nonfatal verdict is needed, preserve its old semantics first and route the existing positive row through it; this makes the missing rejection observable before the expectation repair. No existing source/test bytes were overlaid or replaced by this audit.

| Regression on the real affected oracle | RED meaning before correction | GREEN requirement and necessary accepted control |
| --- | --- | --- |
| Coherent wrong new selection at a real final-prune caller | Declare desired fixture N but produce another independently valid fixture Q through the genuine Publish/final-prune A/B setup. Keep old and actual lease witnesses. The old oracle adopts observed Q and its internally valid graph; the assertion that it must reject disagreement with N fails. This tests the oracle, not production's ability to corrupt N into Q. | Shared caller verdict rejects Q even with correct phase labels, valid graph and intact A/B. The same final-prune fixture producing N is accepted. Keep legitimate CURRENT inode replacement and correct cleanup refusal. |
| Wrong F03A intended-anchor payload | Predeclare the requested JOURNAL `{New:old, State:prepared}` but construct the equally well-formed `{New:old, State:committed}` retained-prepared case at the same existing cut. Presence and record/anchor consistency alone pass; the desired oracle-rejection assertion fails. | Helper used by G2:242/323 and RR:211 rejects wrong desired anchor bytes while accepting correct requested payload, correct absence cases and same-inode base anchors. Do not merely mutate a record into invalid JSON and call parser refusal semantic proof. |
| Changed nonempty displaced-A sentinel | After early Recover refusal and before the shared two-root verdict, change external A's sentinel from `original` to another nonempty string; leave B/authority intact. Existing connector-only plus nonempty checks fail to reject it. | Exact premove-A payload witness rejects it. Unmodified moved A passes both after Recover and after Check. This proves observation at the named cut, not provider/production deletion behavior. |
| Same-byte replacement of displaced A | Keep original moved A alive at another private fixture-owned name, create a same-byte replacement tree at movedPath with distinct directory/member inodes, and invoke the same actual-row oracle before restoration. Keeping original alive prevents inode-reuse ambiguity. | Exact identity/type/membership witness rejects the replacement although bytes are identical. The true renamed A with unchanged identities remains accepted; valid bounded restoration/recovery/retry still succeeds. |

Retain existing independent-root/history/phase negative tests and positive controls. A comparator that rejects everything fails the correct N, correct F03A, unchanged moved A, ordinary replacement-inode, held-reader and fresh-retry positives. The negative fixtures must call the same verdict that the existing production-facing rows use; adding an isolated new comparator test without migrating those rows repeats the defect. Keep all existing fault timing and actual side effects; the incorrect-output control does not authorize a production mutation hook, arbitrary malformed-authority recovery or a new product guarantee.

After the negative assertions fail for the stated reason, implement only the expected-input/witness correction in E, DM, PT, G2 and RR (plus a narrowly named test-only file if that keeps the four negative controls legible). Update exact obligation/claim references and current evidence companion. Preserve prior immutable files. New test content, candidate SHA/tree, exact selector, environment, source hashes, raw results and terminal lifecycle must be captured normally by the owner. If any optional overlay is used later, record its new virtual path, absence before use, content/overlay hashes and unchanged original bytes. No overlay exists for this audit and none is required by this design.

## Ten mandatory lenses

| Lens | Complete-ledger audit disposition / limit |
| --- | --- |
| Architecture and data flow | 089's full route remains supported: main/lock-render admission → retained publication roots → stage/control graph → selected validation/loader/preflight. Independently traced repaired partial-open/common-record/allocator and all seven phase-owner edges; correction stays in the existing test owner. No second runtime reader/framework. |
| Happy, bad and edge behavior | Checked retained-complete versus incomplete/unknown records, actual exclusive collisions, absence/compound results, phase-free/bootstrap shapes, empty/nonempty B and fresh refusal/retry. Both residual findings concern what tests observe, not permission to accept arbitrary malformed authority. |
| State and concurrency | Distinguished prepared/committed new-selected, true final prune, rejected-new fresh Recover, immediate rollback, held-reader variants and early/late stage cuts. Preserved operation locking, reader directory-lifetime/lease separation and sequential restored test seams; explicit desired deltas are still required. |
| Security and secret taint | Descriptor-relative no-follow/type-bound acquisition and no-replace ownership remain relevant protections; no secrets/provider I/O are in this local authoring correction. Moved-stage witness must use the same safe acquisition discipline. No demonstrated security exploit added to the ledger. |
| Retry, resume and idempotency | Actual allocator producer/consumer roles and bounded fresh retries support 02/03; new oracle must retain correct recovered terminal state and bounded fixture restoration. No remote rate/retry guarantee is claimed. |
| Output integrity | Pure generation/integrity derivation and production physical validation remain. 089-01 shows why graph agreement does not prove desired fixture output; 089-02 shows why success after restoration does not prove prior displaced-A preservation. |
| Declaration reachability and closed surface | Full 089 loader/engine/manifest/preflight analysis is retained; no lock corpus, lane declaration or runtime executor addition appears in the proposed correction. Atlas selection/constraints still describe the existing authoring foundation; update proof references only if they change. |
| CLI and App parity | Authoring lock-render/signal/docs changes retain 089's coverage and verified supplementary receipts. The proposed test/evidence correction changes no runtime command, App route, help flag or approval contract. |
| Provider semantics | Evidence-based bounded N/A: no provider facts, transport, paging, credentials, warehouse/database execution or connector corpus is changed. No live service was touched and no external research/certification is inferred. |
| Tests and evidence | Full six-finding ledger, 28 proof groups, every 089 cleanup sibling and all three F03A helper consumers reconciled. Original/final/historical/cached evidence classes remain distinct. Oracle design remains unexecuted and CP11 unaccepted. |

## Validation dependency closure and evidence reuse

The final packet's 13 receipt digests and their 13 raw-output digests all verified. The normal and race receipts each bind 211 source inputs, all matching the frozen worktree. Their raw JSONL each contains 622 test/subtest run and pass events, zero test failure/skip events, and a terminal package pass; neither is cached. They are **owner-executed original results**, not runs by this auditor:

| Evidence class | Verified result and reuse limit |
| --- | --- |
| Full normal, frozen 8aadc1ce | `go test -json -count=1 -timeout 20m ./cmd/connectorgen`, exit 0; wall 380.2870865839941s, package 377.558s. |
| Full race, frozen 8aadc1ce | `go test -race -json -count=1 -timeout 20m ./cmd/connectorgen`, exit 0; wall 862.4320933749841s, package 855.987s. Recorded environment: darwin/arm64, Go1.26.6, CGO_ENABLED=1, empty GOFLAGS. These prove this candidate's old tests ran, not a future test candidate or missing assertions. |
| Original-range lint | Receipt `aac3bdfb46677a81e1942eab1d1d31a276ed67edc26392f9cf8959dced36584f`; raw JSON/log match, 868 config/source/test/dependency hashes match current inputs, exit 0 and zero introduced issues for `--new-from-rev 36e4d980... ./...`. It ran before freeze at cf417bcf, then bound to unchanged inputs; it is not relabeled as a command launched at 8aadc1ce. No independent wall duration was captured. |
| Supplementary original results | Vet, connectorgen/pm builds, tidy diff, agent-contract, definitions, boundary scanner, docs/help, release and canon-static receipts have terminal exit 0. Definitions reports 553/0. Boundary scanner reports 284 files/553 connectors, zero findings/warnings, six exceptions; it is not a boundary **package** pass. Canon used the exact static prefix plus source-lock/Atlas selector coverage in the completed full package runs; no redundant subset run is fabricated. |
| Historical limits | Cached runtime preflight remains cached. Historical boundary-package invalid_cli_surface failure/limited original-source reproduction and CP29 debt remain distinct. Archive whitespace has its exact historical exclusion; no general clean diff claim. No provider-live, Linux runtime, process power-loss or entire-repository certification follows. |

For the proposed five-test-file/evidence correction, the minimal **fast feedback** dependency closure is all consumers of `CaptureExpectedCut`, `ExpectedCompletedTransitions`, the revised pending-prepared helper, and the combined early-stage witness, plus their existing positive/negative comparators. Concretely run the eleven `cut:*` groups in the manifest together, the three F03A/RR consumers above, `TestCP11F03ARepairPostRecordFailureRetainsCoherentAuthority`, the existing three `oracle` tests, and the four new falsification tests. Add any actual additional consumer found by the final helper-reference search. An exact alternation of these actual top-level names in one `go test -json -count=1 -timeout 20m ./cmd/connectorgen -run '^(...)$'` and the same with `-race` verifies interactions among new witnesses and shared seams. Require selected/run/pass names in raw output, not only exit 0. Run gofmt on changed test files and test-inclusive vet/introduced lint for the changed candidate. No new generic checker project is required.

Fast closure does **not** waive final gates. Current QUALITY QE-28 requires actual full required package normal and race commands on the final intended **code/test/dependency** state; test changes invalidate that gate even if production bytes stay fixed. After the complete test correction freezes, rerun the full `./cmd/connectorgen` normal and race commands once on that coherent candidate, bind receipts to its source/test/dependency state, and rerun original-base introduced lint under QE-29 because test inputs changed. The old full runs remain valuable historical evidence for unchanged production and old tests; label any reuse as input-equivalent historical coverage, never as a full new-candidate run. Original-base independent review of the entire new final candidate remains mandatory; no accepted baseline or next-phase acceptance is created here. Approved088 overlap may be used only within its stated coherent-candidate/custody limits.

Production build, dependencies/tidy, fixed execution corpus/definitions, unchanged docs/help/release inputs and local authoring boundary scan do not acquire new behavior from test/evidence-only edits. Their existing results may be referenced through an explicit unchanged-input mapping when the owning gate permits reuse; do not rerun them merely to reproduce receipts. Recompute input hashes and relevant generated/evidence-reference checks if the correction changes those inputs (especially Atlas proof entries or evidence projections). Vet/lint include test files and must not be declared current by production-only equivalence. Full-repository tests, live services and historical-debt reproducers are not added to this bounded correction. Any actually required gate still applies; this is a dependency assessment, not waiver authority.

## Commands, remaining uncertainty and terminal lifecycle

This auditor executed only local inspection and authorized report/journal creation: Git identity/status/ancestor/diff reads; skill/context/source reads; installed GSD source resolution; SHA checks and exact-byte embedding checks; manifest ID/reference/assertion/source reconciliation; raw receipt/event/source-binding reconciliation. These completed. Small inspection-script mistakes (dictionary shape assumptions and one incorrect raw-output suffix fallback, corrected before reconciliation) were terminal inspection errors, not test/probe failures. No test, overlay probe, full-suite rerun, runtime, provider, database, credential operation, ref change, child agent or publication was executed. No active command or probe remains at return. The private report and the explicitly assigned run journal/finding files are the only files this auditor created/edited.

Firstmate093 enrolled this active run in the new logging supplement at a natural tool boundary. Its exact instruction SHA-256 `20655e5ad3d4f675413c871ebab9aec2c6a77036ea0558e0f89b3706e4242109` was verified. The first actual auditor journal update is dated 2026-09-06T11:08:34Z, without backdating earlier work. [RUN.md](/Users/karthiksivadas/pm-cli-agent-workspace/data/review-runs/cp11-audit-091-8aadc1ce-20260906T103133Z/RUN.md) retains the three canonical finding IDs, final report hash and terminal state. This observability supplement changes no scope or gate.

The remaining uncertainty is specific: the proposed test-only implementation and its rejection/acceptance controls have not been written or run; a future candidate still needs the affected and mandatory final gates plus original-range independent review. No current production counterexample was demonstrated for either proof blocker. Exact historical080 policy bytes remain unrecovered, while current087/088 authority is resolved to immutable bytes. No external blocker or unresolved product/architecture decision prevents the owner from preparing the bounded correction for authorization.
