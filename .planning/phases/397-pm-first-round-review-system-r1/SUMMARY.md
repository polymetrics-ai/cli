...
- Focused/full gates at `7f1b2d8fe` are historical. Graph/lab focused GREEN is complete; fresh full gates, exact-head packet review/labs, Shepherd, no-mistakes, PR, and CI remain pending.
