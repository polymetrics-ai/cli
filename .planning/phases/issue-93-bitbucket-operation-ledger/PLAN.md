# Plan: Full official Bitbucket Swagger operation ledger coverage and typed blocked-operation metadata.
...
Full official Bitbucket Swagger operation ledger coverage and typed blocked-operation metadata.
...
Completed: `api_surface.json` and `operations.json` enumerate all 331 official Bitbucket Swagger operations with coverage or blocked-operation metadata. Full local gates passed; see `TDD-LEDGER.md`, `VERIFICATION.md`, and `RUN-STATE.json` for evidence.
