...
- Linked sub-issues:
  - #3581 target-scope core validator — sub-PR #3590 open; next critical path
...
- Recovery status: transient session failure reconciled; #3583 no-mistakes validation passed and parent roadmap artifacts were restored/updated after the squash merge.
