...
| 1 | RED | Focused version/router tests | Pending | Must fail because version is still a legacy `DisableFlagParsing` wrapper. |
...
Exact RED output will be inserted here immediately after running tests and before any production-code edit.
