...
- A complete Swagger 2.0 document is pinned with `artifact.swagger: "2.0"` and projects through the existing Swagger importer. It is excluded from `openapi_versions`, which remains the inventory of OpenAPI 3.0/3.1 documents only.
