...
- Delivery: PR #4295 targets `fm/cli-reverse-etl-destination-r1`, with source-driven inventories, rematerialized parity ledgers, and a 20-row seven-surface report. The published #4304 App/CLI generic-destination dispatch head is merged into this branch and exercised by focused tests; its still-open PR remains the parent dependency until it lands.
