...
| Safety/docs | Docs showed metadata-only blocked surface | Docs/catalog/manual now show read/write capabilities, 129 write actions, and reverse-ETL approval gates; `./pm docs validate --connectors-dir docs/connectors` passed | complete |
