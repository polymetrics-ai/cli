...
- Lane prompt: `scripts/gsd prompt execute-phase issue-87-gitlab-direct-read --tdd`
...
Add bounded JSON-redacted direct-read support and enable safe GitLab direct-read commands.

## Scope

internal/connectors/engine/direct_read.go, schema/cli_surface.schema.json, validate.go, gitlab cli/api surface
