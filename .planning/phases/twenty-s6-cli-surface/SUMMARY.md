...
- Review fix F1: corrected Twenty metadata/manual/skill approval wording so every reverse ETL write, including creates, requires plan/preview/approval/execute; delete actions additionally require typed `--confirm destructive`.
