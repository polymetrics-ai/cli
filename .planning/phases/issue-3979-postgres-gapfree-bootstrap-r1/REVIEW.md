...
4. **No remaining blocking finding.** The coordinator owns no target handle. Its snapshot receiver is documented as the connection-owned WAL/Parquet durability boundary and carries a full candidate checkpoint; post-barrier records retain #3977's receipt → checkpoint → LSN acknowledgement ordering.
