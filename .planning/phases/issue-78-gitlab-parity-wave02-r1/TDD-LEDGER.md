...
- [x] Surface count check captured: `python3 .planning/phases/issue-78-gitlab-parity-wave02-r1/traces/gitlab_surface_counts.py` reports 1,146 official operations, 1,147 api/CLI rows, lane counts 399 ETL/read, 637 reverse ETL write, 6 direct/query/search/metadata, 87 binary/file, 15 CDC/changefeed, and 2 excluded/not-applicable.
- [x] Inventory verifier refresh captured: `python3 .planning/phases/issue-78-gitlab-parity-wave02-r1/traces/gitlab_inventory_check.py` passed after sharing generator path normalization for grouped optional route segments.
