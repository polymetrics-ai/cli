...
- Represented all 1,146 official operations with connector-local lane counts: 399 ETL/read, 637 reverse ETL write, 6 direct/query/search/metadata, 87 binary/file, 15 CDC/changefeed, and 2 excluded/not-applicable.
