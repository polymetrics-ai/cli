...
- Implemented #151 locally with full verification: fan-out parent pagination override, Chatwoot message `after` cursor pagination, message-id cursor metadata, stream fixtures, conformance sweep coverage, docs/catalog/website data updates.
...
4. Open the stacked #151 PR and route remote checks/review.
