...
- Implemented #153 locally with full verification: bounded JSON direct-read output policy, scoped base-path handling, and selected Chatwoot `conversation view`, `contact view`, and `contact search` direct reads.
...
4. Open the stacked #153 PR and route remote checks/review.
