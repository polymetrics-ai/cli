# Generated by scripts/gsd prompt quick --validate Parent orchestration for issue #148 Chatwoot CLI parity and local critical path planning for issue #149
...
# Execute official GSD command in Pi: /gsd-quick --validate Parent orchestration for issue #148 Chatwoot CLI parity and local critical path planning for issue #149
...
- Command: `/gsd-quick`
- Args: `--validate Parent orchestration for issue #148 Chatwoot CLI parity and local critical path planning for issue #149`
