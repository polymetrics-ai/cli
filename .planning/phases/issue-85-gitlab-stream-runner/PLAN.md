...
- Lane prompt: `scripts/gsd prompt execute-phase issue-85-gitlab-stream-runner --tdd`
...
Prove implemented GitLab stream-backed commands execute through the generic connector runner.

## Scope

internal/cli/cli_test.go, internal/connectors/commandrunner tests
