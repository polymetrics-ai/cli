# Plan: GitLab Sensitive Admin (#89)
...
- Lane prompt: `scripts/gsd prompt execute-phase issue-89-gitlab-sensitive-admin --tdd`
...
Ensure sensitive/admin/destructive GitLab operations are risk-tiered, redacted, approval-gated, and blocked by default.

## Scope

gitlab cli/api surface, docs
