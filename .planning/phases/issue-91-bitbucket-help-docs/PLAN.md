# Plan: Help renderer, CLI manual, connector docs, and website parity for the Bitbucket namespace.
...
Help renderer, CLI manual, connector docs, and website parity for the Bitbucket namespace.
...
Completed: runtime connector help fallback now renders Bitbucket manual/command surface for `pm help bitbucket`, bare `pm bitbucket`, and `pm bitbucket --help`; docs/catalog/website data regenerated. Full local gates passed; see `TDD-LEDGER.md`, `VERIFICATION.md`, and `RUN-STATE.json` for evidence.
