...
| CLI transcript parity | `POLYMETRICS_UPDATE_GOLDEN_TRANSCRIPTS=1 go test -count=1 -timeout 20m ./internal/cli -run '^TestGoldenTranscripts$'`; focused golden/docs/surface rerun | pass — sanctioned fixture regeneration updated only the ten help/manual transcripts changed by this issue; rerun passed |
