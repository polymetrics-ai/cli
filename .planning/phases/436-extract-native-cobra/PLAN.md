...
Completed and verified at implementation head `15417f956f428c73159b3bb8824eb55cf3d44d36`. Initial RED, native GREEN, and the post-GREEN warehouse-root containment RED/GREEN all preceded their production edits. Focused/repeated/race extract/RLM/safety, router/golden, exact-start 8/8 preserved plus 5/5 intentional help, full CLI/repository, docs/manual/website generation, runtime help/output/hidden checks, gofmt, vet, build, module/scope guards, and final `make verify` pass. Website TypeScript typecheck was not applicable locally because existing `node_modules`/`tsc` is absent and dependency installation was prohibited; dependency-free docs data generation passed with no unexpected delta. No external user file/service, credential, dependency, PR, or review was used.
