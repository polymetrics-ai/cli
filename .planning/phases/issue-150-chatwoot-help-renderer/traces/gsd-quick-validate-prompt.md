# Generated by scripts/gsd prompt quick --validate Issue #150 Chatwoot help renderer docs parity using Chatwoot cli_surface metadata
...
# Execute official GSD command in Pi: /gsd-quick --validate Issue #150 Chatwoot help renderer docs parity using Chatwoot cli_surface metadata
...
- Command: `/gsd-quick`
- Args: `--validate Issue #150 Chatwoot help renderer docs parity using Chatwoot cli_surface metadata`
