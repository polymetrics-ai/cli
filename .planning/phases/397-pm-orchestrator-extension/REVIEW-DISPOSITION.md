...
- The Gong operation direct-read defect needs a separate product issue/fix owner; no credentialed or live call is needed to reproduce its local preflight failure.
