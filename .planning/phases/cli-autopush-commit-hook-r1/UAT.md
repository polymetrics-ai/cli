...
| --- | --- | --- |
| Refusal and replay safety | `scripts/tests/post-commit-autopush.sh` runs a real two-commit rebase, manual merge/cherry-pick/revert completion, delayed children during and after a manual merge, stale/default-pushurl, detached, and opt-out cases. | Pass |
