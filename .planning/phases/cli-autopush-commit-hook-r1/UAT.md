...
| Rate and worktree safety | The same harness proves a shared linked-worktree state path, concurrent leasing, dead-lease recovery, ten-minute skip, expiry catch-up, and a receive-delayed detached push. | Pass |
