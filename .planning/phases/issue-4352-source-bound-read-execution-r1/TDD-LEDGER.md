...
## R5-pass reconciliation with `main` `b9b2478` — 2026-08-27

- **Red carry-forward:** #4357's recorded red was an undefined `sourceProjectionApplyWriteDisabledMutationArtifacts` helper. Its complete red/green record remains in `issue-4329-read-only-mutation-artifacts-r2/TDD-LEDGER.md`; no source lock or provider byte changed here.
