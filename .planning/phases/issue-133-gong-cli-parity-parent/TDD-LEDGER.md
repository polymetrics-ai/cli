...
- Follow-up review probe showed `pm gong --bogus` also rendered help successfully. Red captured; flag-only help is now restricted to connector-declared global flags, while invalid flags return a usage error as required.
