...
- Scope owner: `internal/connectors/defs/zoom/**`, Zoom-local tests and fixtures, the Zoom-only generated endpoint projection, Zoom connector docs, and this phase evidence. No other connector and no shared runtime/tooling changes are in scope.
