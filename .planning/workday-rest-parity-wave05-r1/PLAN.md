...
5. Implemented 252 non-binary/non-generic-query mutation operations as typed write actions with closed root record schemas, path-field redaction, risk text, and destructive delete confirmation/idempotent 404 handling.
6. Marked 31 binary/file/fixed-query/generic-query current-contract gaps as blocked operation-ledger rows with official source evidence. No raw query/path/body or binary passthrough was added.
