# Generated by scripts/gsd prompt quick --full Implement issue #188 Front full documented connector parity in internal/connectors/defs/front only; update GSD plan, TDD ledger, verification, conformance evidence; no live provider calls, no no-mistakes, no push/PR.
# Repo: /Users/karthiksivadas/.treehouse/cli-83d592/20/cli
# Official GSD: github.com/open-gsd/gsd-core@20297a8ff941378b8615a5d3e8629e52c10a0f9d
# Runtime adapter: pi-project-local

# Execute official GSD command in Pi: /gsd-quick --full Implement issue #188 Front full documented connector parity in internal/connectors/defs/front only; update GSD plan, TDD ledger, verification, conformance evidence; no live provider calls, no no-mistakes, no push/PR.
...
- Command: `/gsd-quick`
- Args: `--full Implement issue #188 Front full documented connector parity in internal/connectors/defs/front only; update GSD plan, TDD ledger, verification, conformance evidence; no live provider calls, no no-mistakes, no push/PR.`
...
- `/Users/karthiksivadas/.treehouse/cli-83d592/20/cli/.gsd/commands.json`
- `/Users/karthiksivadas/.treehouse/cli-83d592/20/cli/.gsd/upstream.lock.json`
- `/Users/karthiksivadas/.treehouse/cli-83d592/20/cli/.gsd/official-docs/COMMANDS.md`
