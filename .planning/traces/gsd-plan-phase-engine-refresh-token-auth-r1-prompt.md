# Generated by scripts/gsd prompt plan-phase engine-refresh-token-auth-r1
...
# Execute official GSD command in Pi: /gsd-plan-phase engine-refresh-token-auth-r1
...
- Args: `engine-refresh-token-auth-r1`
