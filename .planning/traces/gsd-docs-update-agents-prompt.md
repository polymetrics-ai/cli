# Generated by scripts/gsd prompt docs-update .planning AGENTS.md .agents --planning-only
...
# Execute official GSD command in Pi: /gsd-docs-update .planning AGENTS.md .agents --planning-only
...
- Args: `.planning AGENTS.md .agents --planning-only`
