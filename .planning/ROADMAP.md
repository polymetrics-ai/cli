# Planning Roadmap Entry Point

The July 2026 roadmap was moved to
[the connector-canon archive](../docs/connector-canon/archive/superseded-repository-planning/planning-roadmap-2026-07-08.md).
It prescribed stale inventory assumptions and the absent `programming-loop`
command.

Current connector delivery follows the
