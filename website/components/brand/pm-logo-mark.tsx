    ...
    >
      <style>
        {`
          ...
          .pm-logo-mark__m {
            opacity: 0;
            animation: pm-logo-mark-m 1.08s ease-in-out infinite;
          }

          .pm-logo-mark__cursor {
            opacity: 1;
            animation: pm-logo-mark-cursor 1.08s ease-in-out infinite;
          }

          @keyframes pm-logo-mark-m {
            0%, 42% { opacity: 1; transform: translateY(0); }
            48%, 90% { opacity: 0; transform: translateY(-0.8px); }
            100% { opacity: 1; transform: translateY(0); }
          }

          @keyframes pm-logo-mark-cursor {
            0%, 42% { opacity: 0; transform: translateY(0.8px); }
            48%, 90% { opacity: 1; transform: translateY(0); }
            100% { opacity: 0; transform: translateY(0.8px); }
          }
