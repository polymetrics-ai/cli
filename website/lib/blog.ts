...
parent      -> full verification -> human merge -> release`,
      ...
      },
      {
        ...
        body: [
          ...
          'The website has its own integration harness. It starts PostgreSQL 17 and follows the website workflow check sequence before building the container image. That sequence catches failures that a component test cannot: migrations, generated catalog mismatches, route rendering, browser behavior, static analysis, and production compilation.',
        ],
        points: [
          ...
          'Website checks: PostgreSQL-backed app verification, generated-data drift checks, static analysis, browser coverage, production build, and image construction.',
        ],
        evidenceRefs: [
