...
export const CONNECTOR_CATEGORY_COUNTS = {"api":546,"queue":1,"database":2,"email":1,"accounting":1} as Record<string, number>;

export const CONNECTOR_RELEASE_STAGE_COUNTS = {"ga":485,"alpha":38,"beta":27,"planned":1} as Record<string, number>;

export const CONNECTOR_CAPABILITY_COUNTS = {"check":550,"read":550,"write":233,"query":0,"cdc":0,"dynamicSchema":4} as Record<keyof ConnectorCapabilities, number>;
