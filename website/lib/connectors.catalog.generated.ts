...
export const CONNECTOR_RELEASE_STAGE_COUNTS = {"ga":485,"alpha":39,"beta":26,"planned":1} as Record<string, number>;

export const CONNECTOR_CAPABILITY_COUNTS = {"check":550,"read":550,"write":232,"query":0,"cdc":0,"dynamicSchema":4} as Record<keyof ConnectorCapabilities, number>;
