...
export const CONNECTOR_CATEGORY_COUNTS = {"api":546,"queue":1,"database":3,"accounting":1} as Record<string, number>;

export const CONNECTOR_RELEASE_STAGE_COUNTS = {"ga":486,"alpha":38,"beta":26,"planned":1} as Record<string, number>;

export const CONNECTOR_CAPABILITY_COUNTS = {"check":550,"read":550,"write":233,"query":0,"cdc":1,"dynamicSchema":5} as Record<keyof ConnectorCapabilities, number>;
