...
const changelogTocItems = [
  { id: 'changelog-overview', label: 'Overview' },
...
export default function ChangelogPage() {
  return (
    <div className="mx-auto flex w-full max-w-[95rem] overflow-clip">
      ...
      <main className="min-w-0 flex-1 pattern-bg px-6 py-16 md:py-24">
        <div className="mx-auto w-full max-w-[900px]">
          ...
          <section
            ...
            className="scroll-mt-24 divide-y divide-line-structure border-y border-line-structure"
          >
      ...
      <PageAside items={changelogTocItems} discussionTitle="Changelog" />
    </div>
  );
}
