...
- CodeRabbit auto-review where the base branch is `main`; for stacked sub-PRs into the parent
  branch where CodeRabbit is disabled, the parent PR must receive review coverage for the
