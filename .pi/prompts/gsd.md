...
6. For CLI command, flag, help, output, connector-surface, or website-doc changes, read `.agents/agentic-delivery/references/cli-help-docs-website-parity.md` and include runtime help, bare namespace behavior, `docs/cli/**`, website docs, generated help/manual artifacts, and tests in the plan.
